    ...
    <section class="regular-booking-page animate-fade-in">
        <section class="regular-booking-page-header">
            <div class="regular-booking-page-copy">
                <h1>Invoice Pemesanan Dropping</h1>
                <p>Invoice ini dibuat setelah pembayaran dicatat untuk dropping booking.</p>
            </div>
            ...
            <section class="regular-booking-form-card">
                <section class="regular-booking-review-status-card">
                    <div class="regular-booking-review-status-copy">
                        <h2>Invoice Dropping Siap Dilihat</h2>
                        <p>Pembayaran dropping booking {{ $invoiceState['booking_code'] }} sudah dicatat. Gunakan invoice ini sebagai ringkasan transaksi resmi sebelum membuka e-ticket dropping.</p>
                    </div>
                ...
                <section class="regular-booking-section">
                    <div class="regular-booking-section-head">
                        ...
                        <p>Seluruh data invoice diambil dari dropping booking yang sudah menyelesaikan tahap pembayaran.</p>
                    </div>
                ...
                <section class="regular-booking-section">
                    <div class="regular-booking-section-head">
                        <h2>Informasi Perjalanan Dropping</h2>
                        <p>Rute dan kursi dropping yang tercatat pada booking aktif.</p>
                    </div>
                ...
                <div class="regular-booking-form-actions">
                    <a href="{{ route('dropping-bookings.invoice.download') }}" class="dashboard-ghost-button">Download PDF Invoice</a>
                    <a href="{{ route('dropping-bookings.ticket') }}" class="dashboard-primary-button">Lihat E-ticket Dropping</a>
            ...
            <aside class="regular-booking-sidebar">
                <section class="regular-booking-summary-card">
                    <div class="regular-booking-summary-head">
                        ...
                        <p>Panel ringkas ini memudahkan verifikasi data transaksi dropping.</p>
                    </div>
