...
<head>
    <meta charset="utf-8">
    <title>{{ $ticketState['ticket_number'] }} — Dropping</title>
    <style>
        body {
...
<body>
    <div class="ticket-shell">
        <section class="ticket-header">
            ...
            <p class="ticket-subtitle">Dokumen tiket elektronik untuk perjalanan dropping yang sudah tercatat pada sistem.</p>
            ...
            <div class="ticket-badges">
                ...
                <span class="badge badge-dropping">Tiket Penumpang Dropping</span>
            </div>
        </section>

        <section class="ticket-section">
            <h2 class="section-title">Informasi Tiket Dropping</h2>
        ...
        <section class="ticket-section">
            <h2 class="section-title">Penumpang Terdaftar — Dropping</h2>
