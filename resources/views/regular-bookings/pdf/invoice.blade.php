...
<head>
    <meta charset="utf-8">
    <title>{{ $invoiceState['invoice_number'] }}</title>
    <style>
        body {
...
<body>
    <div class="invoice-shell">
        <section class="invoice-header">
            ...
            <p class="invoice-subtitle">Dokumen ini diterbitkan dari sistem dashboard pemesanan reguler.</p>
            ...
            <table class="meta-grid">
                ...
                <tr>
                    <td>
                        ...
                        <span class="meta-value">{{ $invoiceState['driver_name'] }}</span>
                    </td>
                    <td>
        ...
        <section class="invoice-footer">
            Invoice ini dihasilkan secara otomatis oleh sistem untuk kebutuhan verifikasi transaksi pemesanan reguler.
        </section>
    </div>
</body>
</html>
