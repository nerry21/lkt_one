            ...
            <tr>
                <td width="80" valign="middle">
                    <div style="width:68px; height:68px; border-radius:50%; border:3px solid #fff; background:#fff; overflow:hidden; text-align:center; line-height:68px;">
                        <img src="{{ public_path('images/jet_travel.png') }}" style="width:64px; height:64px; object-fit:contain; vertical-align:middle; border-radius:50%;" alt="JET (JAYA EXCECUTIVE TRANSPORT) Logo">
                    </div>
                </td>
