<div class="ddrop-form-grid">
    ...
    <div class="ddrop-section-divider">Rute Rental</div>
    ...
    <div class="ddrop-section-divider">Periode & Jadwal Rental</div>

    <div class="ddrop-form-field">
        <label>Tanggal Mulai Rental <span class="req">*</span></label>
        <input type="date" name="trip_date" class="ddrop-form-input"
            value="{{ old('trip_date', $booking?->trip_date?->format('Y-m-d') ?? '') }}" required>
    </div>

    <div class="ddrop-form-field">
        <label>Tanggal Selesai Rental <span class="req">*</span></label>
        <input type="date" name="rental_end_date" class="ddrop-form-input"
    ...
    <div class="ddrop-form-field">
        <label>Jam Keberangkatan Pulang</label>
        <input type="time" name="return_trip_time" class="ddrop-form-input"
            value="{{ old('return_trip_time', isset($booking) ? substr($booking->return_trip_time ?? '', 0, 5) : '') }}">
    </div>

    <div class="ddrop-section-divider">Tarif</div>

    <div class="ddrop-form-field">
        <label>Tarif Rental (Rp) <span class="req">*</span></label>
        <input type="number" name="price_per_seat" class="ddrop-form-input"
            ...
            placeholder="Tarif rental" min="0" step="1000" required>
    </div>

    <div class="ddrop-form-field">
        <label>Tambahan Ongkos (Rp)</label>
