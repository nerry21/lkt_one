...
<div class="page-actions">
    <a class="btn-back" href="{{ route('dropping-data.index') }}">← Kembali ke Data Dropping</a>
...
<div class="ticket">
    ...
    <div class="ticket-body">
        ...
        <div class="ticket-left">
            <div class="ticket-section-title">Tiket Penumpang Dropping</div>
        ...
        <div class="ticket-right">
            ...
            <ul class="ticket-rules">
                <li data-no="1">Tiket ini merupakan pemesanan dropping — seluruh armada dipesan untuk satu perjalanan.</li>
