...
<head>
    ...
    <title>E-Ticket Rental {{ $ticketState['ticket_number'] }} | JET (JAYA EXECUTIVE TRANSPORT)</title>
    <style>
...
<div class="ticket">
    ...
    <div class="ticket-body">
        ...
        <div class="ticket-left">
            <div class="ticket-section-title">Tiket Penumpang Rental</div>

            <div class="ticket-field">
                <span class="ticket-field-label">Nama Pemesan</span>
            ...
            <div class="ticket-sub-title">Periode Rental</div>

            <div class="ticket-field">
                <span class="ticket-field-label">Tgl. Mulai Rental</span>
                <span class="ticket-field-colon">:</span>
                <span class="ticket-field-value">{{ $ts['trip_date'] }}</span>
            </div>
            <div class="ticket-field">
                <span class="ticket-field-label">Tgl. Selesai</span>
                <span class="ticket-field-colon">:</span>
                <span class="ticket-field-value">{{ $rentalEndDate }}</span>
            </div>
            <div class="ticket-field">
        ...
        {{-- MIDDLE: Nomor Bangku (semua aktif untuk rental) --}}
        ...
        <div class="ticket-right">
            ...
            <ul class="ticket-rules">
                <li data-no="1">Tiket ini merupakan pemesanan rental mobil — seluruh armada dipesan untuk periode yang ditentukan.</li>
