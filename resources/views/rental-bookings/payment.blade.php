    ...
    <section class="regular-booking-page animate-fade-in">
        <section class="regular-booking-page-header">
            <div class="regular-booking-page-copy">
                <h1>Pembayaran</h1>
                <p>Pilih metode pembayaran untuk rental mobil yang sudah direview dan disimpan sebagai draft.</p>
            </div>
        ...
        <div class="regular-booking-layout">
            <form method="POST" action="{{ route('rental-bookings.payment.store') }}" class="regular-booking-form-card">
                @csrf

                <section class="regular-booking-review-status-card">
                    <div class="regular-booking-review-status-copy">
                        <h2>Rental Mobil Siap Dibayar</h2>
                        <p>Booking {{ $persistedBooking->booking_code }} sudah tersimpan. Tahap ini mencatat pembayaran, memperbarui status booking, dan meneruskan Anda ke invoice serta e-ticket rental.</p>
                    </div>
                ...
                <section class="regular-booking-section">
                    <div class="regular-booking-section-head">
                        ...
                        <p>Pilih metode pembayaran yang akan dipakai untuk melanjutkan proses rental mobil.</p>
                    </div>
                ...
                <section class="regular-booking-section">
                    <div class="regular-booking-section-head">
                        ...
                        <p>Nominal pembayaran mengikuti total tarif dari draft rental mobil.</p>
                    </div>
                ...
                <div class="regular-booking-form-actions">
                    <a href="{{ route('rental-bookings.review') }}" class="dashboard-ghost-button">Kembali ke Review</a>
            ...
            <aside class="regular-booking-sidebar">
                <section class="regular-booking-summary-card">
                    <div class="regular-booking-summary-head">
                        <h2>Ringkasan Pembayaran</h2>
                        <p>Panel ini merangkum rental mobil yang akan dilanjutkan ke invoice dan e-ticket.</p>
                    </div>
