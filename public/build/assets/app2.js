...
`+r):a.stack=r}catch{}}throw a}}_request(t,n){typeof t=="string"?(n=n||{},n.url=t):n=t||{},n=be(this.defaults,n);const{transitional:a,paramsSerializer:o,headers:r}=n;a!==void 0&&rt.assertOptions(a,{silentJSONParsing:oe.transitional(oe.boolean),forcedJSONParsing:oe.transitional(oe.boolean),clarifyTimeoutError:oe.transitional(oe.boolean),legacyInterceptorReqResOrdering:oe.transitional(oe.boolean)},!1),o!=null&&(m.isFunction(o)?n.paramsSerializer={serialize:o}:rt.assertOptions(o,{encode:oe.function,serialize:oe.function},!0)),n.allowAbsoluteUrls!==void 0||(this.defaults.allowAbsoluteUrls!==void 0?n.allowAbsoluteUrls=this.defaults.allowAbsoluteUrls:n.allowAbsoluteUrls=!0),rt.assertOptions(n,{baseUrl:oe.spelling("baseURL"),withXsrfToken:oe.spelling("withXSRFToken")},!0),n.method=(n.method||this.defaults.method||"get").toLowerCase();let s=r&&m.merge(r.common,r[n.method]);r&&m.forEach(["delete","get","head","post","put","patch","common"],b=>{delete r[b]}),n.headers=te.concat(s,r);const i=[];let c=!0;this.interceptors.request.forEach(function(k){if(typeof k.runWhen=="function"&&k.runWhen(n)===!1)return;c=c&&k.synchronous;const p=n.transitional||Xt;p&&p.legacyInterceptorReqResOrdering?i.unshift(k.fulfilled,k.rejected):i.push(k.fulfilled,k.rejected)});const d=[];this.interceptors.response.forEach(function(k){d.push(k.fulfilled,k.rejected)});let l,f=0,E;if(!c){const b=[Cn.bind(this),void 0];for(b.unshift(...i),b.push(...d),E=b.length,l=Promise.resolve(n);f<E;)l=l.then(b[f++],b[f++]);return l}E=i.length;let M=n;for(;f<E;){const b=i[f++],k=i[f++];try{M=b(M)}catch(p){k.call(this,p);break}}try{l=Cn.call(this,M)}catch(b){return Promise.reject(b)}for(f=0,E=d.length;f<E;)l=l.then(d[f++],d[f++]);return l}getUri(t){t=be(this.defaults,t);const n=Ca(t.baseURL,t.url,t.allowAbsoluteUrls);return Ia(n,t.params,t.paramsSerializer)}};m.forEach(["delete","get","head","options"],function(t){fe.prototype[t]=function(n,a){return this.request(be(a||{},{method:t,url:n,data:(a||{}).data}))}});m.forEach(["post","put","patch"],function(t){function n(a){return function(r,s,i){return this.request(be(i||{},{method:t,headers:a?{"Content-Type":"multipart/form-data"}:{},url:r,data:s}))}}fe.prototype[t]=n(),fe.prototype[t+"Form"]=n(!0)});let Mr=class Ma{constructor(t){if(typeof t!="function")throw new TypeError("executor must be a function.");let n;this.promise=new Promise(function(r){n=r});const a=this;this.promise.then(o=>{if(!a._listeners)return;let r=a._listeners.length;for(;r-- >0;)a._listeners[r](o);a._listeners=null}),this.promise.then=o=>{let r;const s=new Promise(i=>{a.subscribe(i),r=i}).then(o);return s.cancel=function(){a.unsubscribe(r)},s},t(function(r,s,i){a.reason||(a.reason=new Xe(r,s,i),n(a.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(t){if(this.reason){t(this.reason);return}this._listeners?this._listeners.push(t):this._listeners=[t]}unsubscribe(t){if(!this._listeners)return;const n=this._listeners.indexOf(t);n!==-1&&this._listeners.splice(n,1)}toAbortSignal(){const t=new AbortController,n=a=>{t.abort(a)};return this.subscribe(n),t.signal.unsubscribe=()=>this.unsubscribe(n),t.signal}static source(){let t;return{token:new Ma(function(o){t=o}),cancel:t}}};function Rr(e){return function(n){return e.apply(null,n)}}function Pr(e){return m.isObject(e)&&e.isAxiosError===!0}const Ht={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511,WebServerIsDown:521,ConnectionTimedOut:522,OriginIsUnreachable:523,TimeoutOccurred:524,SslHandshakeFailed:525,InvalidSslCertificate:526};Object.entries(Ht).forEach(([e,t])=>{Ht[t]=e});function Ra(e){const t=new fe(e),n=pa(fe.prototype.request,t);return m.extend(n,fe.prototype,t,{allOwnKeys:!0}),m.extend(n,t,null,{allOwnKeys:!0}),n.create=function(o){return Ra(be(e,o))},n}const W=Ra(We);W.Axios=fe;W.CanceledError=Xe;W.CancelToken=Mr;W.isCancel=$a;W.VERSION=Aa;W.toFormData=It;W.AxiosError=S;W.Cancel=W.CanceledError;W.all=function(t){return Promise.all(t)};W.spread=Rr;W.isAxiosError=Pr;W.mergeConfig=be;W.AxiosHeaders=te;W.formToJSON=e=>_a(m.isHTMLForm(e)?new FormData(e):e);W.getAdapter=Ta.getAdapter;W.HttpStatusCode=Ht;W.default=W;const{Axios:vd,AxiosError:Ed,CanceledError:wd,isCancel:Bd,CancelToken:Id,VERSION:_d,all:$d,Cancel:Sd,isAxiosError:Cd,spread:xd,toFormData:Ld,AxiosHeaders:Td,HttpStatusCode:Ad,formToJSON:Md,getAdapter:Rd,mergeConfig:Pd}=W;window.axios=W;window.axios.defaults.headers.common["X-Requested-With"]="XMLHttpRequest";const Yt="transit_user",le="transit_token",Ft="transit_pending_toast";function Me(){try{return typeof window<"u"&&typeof window.localStorage<"u"}catch{return!1}}function Pa(){try{return typeof window<"u"&&typeof window.sessionStorage<"u"}catch{return!1}}function Dr(){if(window.transitAuthUser)return window.transitAuthUser;if(!Me())return null;const e=window.localStorage.getItem(Yt);if(!e)return null;try{return JSON.parse(e)}catch{return Ue(),null}}function Da(e){if(!Me()){window.transitAuthUser=e;return}window.transitAuthUser=e,window.localStorage.setItem(Yt,JSON.stringify(e))}function Or(){if(!Me()){window.transitAuthUser=null;return}window.transitAuthUser=null,window.localStorage.removeItem(Yt)}function en(){return typeof window<"u"&&typeof window.transitAuthToken=="string"&&window.transitAuthToken!==""?window.transitAuthToken:Me()?window.localStorage.getItem(le):null}function jr(e){const t=typeof e=="string"?e:"";if(!Me()){window.transitAuthToken=t||null;return}if(window.transitAuthToken=t||null,t===""){window.localStorage.removeItem(le),document.cookie=le+"=; path=/; max-age=0; samesite=lax";return}window.localStorage.setItem(le,t),document.cookie=le+"="+t+"; path=/; max-age=86400; samesite=lax"}function qr(){if(!Me()){window.transitAuthToken=null,document.cookie=le+"=; path=/; max-age=0; samesite=lax";return}window.transitAuthToken=null,window.localStorage.removeItem(le),document.cookie=le+"=; path=/; max-age=0; samesite=lax"}function Nr(e){Pa()&&window.sessionStorage.setItem(Ft,JSON.stringify(e))}function Ur(){if(!Pa())return null;const e=window.sessionStorage.getItem(Ft);if(!e)return null;window.sessionStorage.removeItem(Ft);try{return JSON.parse(e)}catch{return null}}function Ue(){Or(),qr()}function Oa(e,t){if(!e)return t;if(typeof e.detail=="string"&&e.detail!=="")return e.detail;if(typeof e.message=="string"&&e.message!=="")return e.message;if(e.errors&&typeof e.errors=="object"){const n=Object.values(e.errors).flat()[0];if(typeof n=="string"&&n!=="")return n}return t}function Ln(){return document.body.dataset.apiBase||"/api"}function ja(e=""){const t=String(e).replace(/^\/+/,"");return t===""?Ln():`${Ln()}/${t}`}async function v(e,t={}){const{method:n="GET",body:a=null,headers:o={},auth:r=!0}=t,s=new Headers(o);s.set("Accept","application/json"),s.set("X-Requested-With","XMLHttpRequest");let i=a;if(a&&!(a instanceof FormData)&&!(a instanceof Blob)&&(s.set("Content-Type","application/json"),i=JSON.stringify(a)),r){const f=en();f&&s.set("Authorization",`Bearer ${f}`)}if(!["GET","HEAD","OPTIONS"].includes(n.toUpperCase())){const f=document.querySelector('meta[name="csrf-token"]')?.getAttribute("content");f&&s.set("X-CSRF-TOKEN",f)}const c=await fetch(ja(e),{method:n,headers:s,body:i,credentials:"same-origin"});let d=null;const l=c.headers.get("content-type")||"";if(c.status!==204&&(d=l.includes("application/json")?await c.json():await c.text()),!c.ok){c.status===401&&(Ue(),(document.body.dataset.routeGuard||"none")==="protected"&&window.location.replace(document.body.dataset.loginUrl||"/login"));const f=Oa(d,`Request gagal (${c.status})`),E=new Error(f);throw E.status=c.status,E.data=d,E}return d}async function tn(e,t="export.csv"){const n=new Headers({Accept:"text/csv,application/octet-stream","X-Requested-With":"XMLHttpRequest"}),a=en();a&&n.set("Authorization",`Bearer ${a}`);const o=await fetch(ja(e),{method:"GET",headers:n,credentials:"same-origin"});if(!o.ok){let f=null;throw(o.headers.get("content-type")||"").includes("application/json")&&(f=await o.json()),new Error(Oa(f,"Gagal mengunduh file"))}const r=await o.blob(),c=(o.headers.get("content-disposition")||"").match(/filename="?([^"]+)"?/i)?.[1]||t,d=window.URL.createObjectURL(r),l=document.createElement("a");l.href=d,l.download=c,document.body.appendChild(l),l.click(),l.remove(),window.URL.revokeObjectURL(d)}function Pe(e,t){const n=document.getElementById(e);n&&(n.textContent=t)}function Hr(e){const t=e?.role||"";document.querySelectorAll("[data-role-scope]").forEach(n=>{const a=n.dataset.roleScope,o=a==="admin"?["Super Admin","Admin"].includes(t):a==="super"?t==="Super Admin":!0;n.hidden=!o})}function qa(){return Dr()}function dt(e){if(Hr(e),!e)return;const t=e.nama||"Admin",n=t.trim().split(/\s+/)[0]||"Admin",a=e.email||"admin@pekanbaru.com";Pe("sidebar-user-name",t),Pe("sidebar-user-email",a),Pe("header-user-name",n),Pe("dropdown-user-name",t),Pe("dropdown-user-email",a)}function Na(e){return typeof e.access_token=="string"&&e.access_token!==""&&jr(e.access_token),Da(e.user),dt(e.user),e}async function Fr(e){const t=await v("/auth/login",{method:"POST",body:e,auth:!1});return Na(t)}async function Gr(e){const t=await v("/auth/register",{method:"POST",body:e,auth:!1});return Na(t)}async function Tn(){const e=await v("/auth/me");return Da(e),dt(e),e}async function Vr(){try{await v("/auth/logout",{method:"POST"})}catch(e){if(e?.status!==401)throw e}Ue(),Nr({type:"success",title:"Logout berhasil",message:"Sampai jumpa kembali!"}),window.location.replace(document.body.dataset.loginUrl||"/login")}function An(e){window.location.replace(e)}async function Jr(){const e=document.body.dataset.routeGuard||"none",t=document.body.dataset.loginUrl||"/login",n=document.body.dataset.dashboardUrl||"/dashboard",a=qa();if(e==="public"){try{const o=await Tn();return An(n),{user:o}}catch{(a||en())&&Ue()}return{user:null}}if(e==="protected")try{return{user:await Tn()}}catch{return Ue(),An(t),{user:null}}return{user:a}}function nn(){return Array.from(document.querySelectorAll(".modal-shell")).filter(e=>!e.hidden)}function Ua(){document.body.style.overflow=nn().length>0?"hidden":""}function N(e){const t=document.getElementById(e);t&&(t.hidden=!1,Ua())}function Z(e=null){if(e){const t=document.getElementById(e);t&&(t.hidden=!0)}else nn().forEach(t=>{t.hidden=!0});Ua()}function Kr(){document.addEventListener("click",e=>{const t=e.target.closest("[data-modal-open]");if(t){N(t.dataset.modalOpen);return}const n=e.target.closest("[data-modal-close]");if(n){const a=n.dataset.modalClose||n.closest(".modal-shell")?.id;Z(a||void 0)}}),document.addEventListener("keydown",e=>{if(e.key!=="Escape")return;const t=nn().pop();t&&Z(t.id)})}function an(e,t,n){const a=document.getElementById("transit-toast-root");if(!a)return;const o=document.createElement("div");o.className=`transit-toast ${n==="error"?"is-error":""} ${n==="info"?"is-info":""}`.trim(),o.innerHTML=`
    ...
    `}function ct(e){const t=document.getElementById("driver-submit-btn");A.isSubmitting=e,t&&(t.disabled=e,t.textContent=e?"Menyimpan...":A.editItem?"Perbarui":"Simpan")}function gs(){const e=document.getElementById("drivers-table-body");e&&(e.innerHTML=`
        <tr>
    ...
    `)}function Dn(){const e=document.getElementById("drivers-table-body");if(e){if(A.loading){gs();return}if(A.data.length===0){fs();return}e.innerHTML=A.data.map((t,n)=>`
        <tr class="drivers-row" data-testid="driver-row-${t.id}">
            <td class="drivers-index-cell">${(A.page-1)*Le+n+1}</td>
            <td>
    ...
    `).join("")}}function On(){const e=document.getElementById("drivers-pagination-shell"),t=document.getElementById("drivers-pagination-info"),n=document.getElementById("drivers-pagination-page"),a=document.getElementById("drivers-prev-page-btn"),o=document.getElementById("drivers-next-page-btn"),r=Math.max(1,Math.ceil(A.totalCount/Le));e&&(e.hidden=r<=1),t&&(t.textContent=ye(A.page,Le,A.totalCount,A.data.length)),n&&(n.textContent=`${A.page} / ${r}`),a&&(a.disabled=A.page===1),o&&(o.disabled=A.page>=r)}async function Ee(){A.loading=!0,Dn(),On();try{const[e,t]=await Promise.all([v(`/drivers?page=${A.page}&limit=${Le}${A.search?`&search=${encodeURIComponent(A.search)}`:""}`),v(`/drivers/count${A.search?`?search=${encodeURIComponent(A.search)}`:""}`)]);A.data=Array.isArray(e)?e:[],A.totalCount=Number(t.count||0)}finally{A.loading=!1,Dn(),On()}}function jn(){const e=document.getElementById("driver-form"),t=document.getElementById("driver-form-title"),n=document.getElementById("driver-form-description"),a=document.getElementById("driver-id"),o=document.getElementById("driver-nama"),r=document.getElementById("driver-lokasi");e?.reset(),a&&(a.value=""),o&&(o.value=""),r&&(r.value=""),t&&(t.textContent="Tambah Driver Baru"),n&&(n.textContent="Isi form di bawah untuk menambahkan data driver"),A.editItem=null,ct(!1)}function bs(e){const t=document.getElementById("driver-form-title"),n=document.getElementById("driver-form-description"),a=document.getElementById("driver-id"),o=document.getElementById("driver-nama"),r=document.getElementById("driver-lokasi");A.editItem=e,a&&(a.value=e.id),o&&(o.value=e.nama),r&&(r.value=e.lokasi),t&&(t.textContent="Edit Data Driver"),n&&(n.textContent="Isi form di bawah untuk memperbarui data driver"),ct(!1)}async function ks(e){const t=await v(`/drivers/${e}`);bs(t),N("driver-form-modal")}function hs(e){const t=document.getElementById("driver-delete-copy");A.deleteItem=e,t&&(t.innerHTML=`Apakah Anda yakin ingin menghapus driver <strong>${u(e.nama)}</strong>? Tindakan ini tidak dapat dibatalkan.`),N("driver-delete-modal")}function ys(){const e=document.getElementById("drivers-add-btn"),t=document.getElementById("drivers-export-btn"),n=document.getElementById("drivers-search-input"),a=document.getElementById("driver-form"),o=document.getElementById("drivers-table-body"),r=document.getElementById("driver-delete-confirm-btn"),s=document.getElementById("drivers-prev-page-btn"),i=document.getElementById("drivers-next-page-btn");if(!(!e||!a||!o))return e.addEventListener("click",()=>{jn(),N("driver-form-modal")}),t?.addEventListener("click",()=>{tn("/export/drivers/csv","drivers.csv").catch(()=>{y("Gagal mengunduh file")})}),n?.addEventListener("input",he(async c=>{A.search=c.target.value.trim(),A.page=1;try{await Ee()}catch{y("Gagal memuat data")}})),a.addEventListener("submit",async c=>{c.preventDefault();const d={nama:document.getElementById("driver-nama")?.value.trim()||"",lokasi:document.getElementById("driver-lokasi")?.value.trim()||""};ct(!0);try{A.editItem?(await v(`/drivers/${A.editItem.id}`,{method:"PUT",body:d}),U("Data driver berhasil diperbarui")):(await v("/drivers",{method:"POST",body:d}),U("Driver berhasil ditambahkan")),Z("driver-form-modal"),jn(),await Ee()}catch(l){y(l.message||"Silakan periksa input Anda","Gagal menyimpan data")}finally{ct(!1)}}),o.addEventListener("click",async c=>{const d=c.target.closest("[data-driver-edit]"),l=c.target.closest("[data-driver-delete]");try{if(d){await ks(d.dataset.driverEdit);return}l&&hs({id:l.dataset.driverDelete,nama:l.dataset.driverName})}catch{y("Gagal memuat data")}}),r?.addEventListener("click",async()=>{if(A.deleteItem)try{await v(`/drivers/${A.deleteItem.id}`,{method:"DELETE"}),U("Driver berhasil dihapus"),Z("driver-delete-modal"),(A.page-1)*Le>=A.totalCount-1&&A.page>1&&(A.page-=1),A.deleteItem=null,await Ee()}catch{y("Gagal menghapus data")}}),s?.addEventListener("click",async()=>{if(!(A.page<=1)){A.page-=1;try{await Ee()}catch{y("Gagal memuat data")}}}),i?.addEventListener("click",async()=>{const c=Math.max(1,Math.ceil(A.totalCount/Le));if(!(A.page>=c)){A.page+=1;try{await Ee()}catch{y("Gagal memuat data")}}}),Ee().catch(()=>{y("Gagal memuat data")})}const I={data:[],loading:!0,totalCount:0,page:1,search:"",filterJenis:"",editItem:null,deleteItem:null,isSubmitting:!1},Te=10;function vs(){return`
        <svg viewBox="0 0 24 24" fill="none">
    ...
    `}function ut(e){const t=document.getElementById("mobil-submit-btn");I.isSubmitting=e,t&&(t.disabled=e,t.textContent=e?"Menyimpan...":I.editItem?"Perbarui":"Simpan")}function Is(e){return e==="Hiace"?"mobil-jenis-badge mobil-jenis-badge-hiace":"mobil-jenis-badge mobil-jenis-badge-reborn"}function _s(){const e=document.getElementById("mobil-table-body");e&&(e.innerHTML=`
        <tr>
    ...
    `)}function qn(){const e=document.getElementById("mobil-table-body");if(e){if(I.loading){_s();return}if(I.data.length===0){$s();return}e.innerHTML=I.data.map((t,n)=>`
        <tr class="mobil-row" data-testid="mobil-row-${t.id}">
            <td class="mobil-index-cell">${(I.page-1)*Te+n+1}</td>
            <td>
    ...
    `).join("")}}function Nn(){const e=document.getElementById("mobil-pagination-shell"),t=document.getElementById("mobil-pagination-info"),n=document.getElementById("mobil-pagination-page"),a=document.getElementById("mobil-prev-page-btn"),o=document.getElementById("mobil-next-page-btn"),r=Math.max(1,Math.ceil(I.totalCount/Te));e&&(e.hidden=r<=1),t&&(t.textContent=ye(I.page,Te,I.totalCount,I.data.length)),n&&(n.textContent=`${I.page} / ${r}`),a&&(a.disabled=I.page===1),o&&(o.disabled=I.page>=r)}async function ue(){I.loading=!0,qn(),Nn();try{const[e,t]=await Promise.all([v(`/mobil?page=${I.page}&limit=${Te}${I.search?`&search=${encodeURIComponent(I.search)}`:""}${I.filterJenis?`&jenis=${encodeURIComponent(I.filterJenis)}`:""}`),v(`/mobil/count${I.search||I.filterJenis?"?":""}${[I.search?`search=${encodeURIComponent(I.search)}`:"",I.filterJenis?`jenis=${encodeURIComponent(I.filterJenis)}`:""].filter(Boolean).join("&")}`)]);I.data=Array.isArray(e)?e:[],I.totalCount=Number(t.count||0)}finally{I.loading=!1,qn(),Nn()}}function Un(){const e=document.getElementById("mobil-form"),t=document.getElementById("mobil-form-title"),n=document.getElementById("mobil-form-description"),a=document.getElementById("mobil-id"),o=document.getElementById("mobil-kode"),r=document.getElementById("mobil-jenis");e?.reset(),a&&(a.value=""),o&&(o.value=""),r&&(r.value="Hiace"),t&&(t.textContent="Tambah Mobil Baru"),n&&(n.textContent="Isi form di bawah untuk menambahkan data mobil"),I.editItem=null,ut(!1)}function Ss(e){const t=document.getElementById("mobil-form-title"),n=document.getElementById("mobil-form-description"),a=document.getElementById("mobil-id"),o=document.getElementById("mobil-kode"),r=document.getElementById("mobil-jenis");I.editItem=e,a&&(a.value=e.id),o&&(o.value=e.kode_mobil),r&&(r.value=e.jenis_mobil),t&&(t.textContent="Edit Data Mobil"),n&&(n.textContent="Isi form di bawah untuk memperbarui data mobil"),ut(!1)}async function Cs(e){const t=await v(`/mobil/${e}`);Ss(t),N("mobil-form-modal")}function xs(e){const t=document.getElementById("mobil-delete-copy");I.deleteItem=e,t&&(t.innerHTML=`Apakah Anda yakin ingin menghapus mobil <strong>${u(e.kode_mobil)}</strong>? Tindakan ini tidak dapat dibatalkan.`),N("mobil-delete-modal")}function Ls(){const e=document.getElementById("mobil-add-btn"),t=document.getElementById("mobil-export-btn"),n=document.getElementById("mobil-search-input"),a=document.getElementById("mobil-filter-jenis"),o=document.getElementById("mobil-form"),r=document.getElementById("mobil-table-body"),s=document.getElementById("mobil-delete-confirm-btn"),i=document.getElementById("mobil-prev-page-btn"),c=document.getElementById("mobil-next-page-btn"),d=document.getElementById("mobil-kode");if(!(!e||!o||!r))return e.addEventListener("click",()=>{Un(),N("mobil-form-modal")}),t?.addEventListener("click",()=>{tn("/export/mobil/csv","mobil.csv").catch(()=>{y("Gagal mengunduh file")})}),n?.addEventListener("input",he(async l=>{I.search=l.target.value.trim(),I.page=1;try{await ue()}catch{y("Gagal memuat data")}})),a?.addEventListener("change",async l=>{I.filterJenis=l.target.value,I.page=1;try{await ue()}catch{y("Gagal memuat data")}}),d?.addEventListener("input",l=>{l.target.value=l.target.value.toUpperCase()}),o.addEventListener("submit",async l=>{l.preventDefault();const f={kode_mobil:document.getElementById("mobil-kode")?.value.trim().toUpperCase()||"",jenis_mobil:document.getElementById("mobil-jenis")?.value||"Hiace"};ut(!0);try{I.editItem?(await v(`/mobil/${I.editItem.id}`,{method:"PUT",body:f}),U("Data mobil berhasil diperbarui")):(await v("/mobil",{method:"POST",body:f}),U("Mobil berhasil ditambahkan")),Z("mobil-form-modal"),Un(),await ue()}catch(E){y(E.message||"Silakan periksa input Anda","Gagal menyimpan data")}finally{ut(!1)}}),r.addEventListener("click",async l=>{const f=l.target.closest("[data-mobil-edit]"),E=l.target.closest("[data-mobil-delete]");try{if(f){await Cs(f.dataset.mobilEdit);return}E&&xs({id:E.dataset.mobilDelete,kode_mobil:E.dataset.mobilName})}catch{y("Gagal memuat data")}}),s?.addEventListener("click",async()=>{if(I.deleteItem)try{await v(`/mobil/${I.deleteItem.id}`,{method:"DELETE"}),U("Mobil berhasil dihapus"),Z("mobil-delete-modal"),(I.page-1)*Te>=I.totalCount-1&&I.page>1&&(I.page-=1),I.deleteItem=null,await ue()}catch{y("Gagal menghapus data")}}),i?.addEventListener("click",async()=>{if(!(I.page<=1)){I.page-=1;try{await ue()}catch{y("Gagal memuat data")}}}),c?.addEventListener("click",async()=>{const l=Math.max(1,Math.ceil(I.totalCount/Te));if(!(I.page>=l)){I.page+=1;try{await ue()}catch{y("Gagal memuat data")}}}),ue().catch(()=>{y("Gagal memuat data")})}const _={data:[],drivers:[],mobilList:[],loading:!0,totalCount:0,page:1,search:"",editItem:null,deleteItem:null,isSubmitting:!1},He=10,Hn={"05:00":"Subuh (05.00 WIB)","08:00":"Pagi (08.00 WIB)","10:00":"Pagi (10.00 WIB)","14:00":"Siang (14.00 WIB)","16:00":"Sore (16.00 WIB)","19:00":"Malam (19.00 WIB)"},$t="08:00",Ts=["Reguler","Dropping","Rental"],sn="Reguler";function As(){return`
        <svg viewBox="0 0 24 24" fill="none">
            <path d="M4 20H8L18.5 9.5C19.3284 8.67157 19.3284 7.32843 18.5 6.5V6.5C17.6716 5.67157 16.3284 5.67157 15.5 6.5L5 17V20Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"></path>
            <path d="M13.5 8.5L16.5 11.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path>
        </svg>
    ...
    `}function dn(e){return e==="Lunas"?"Lunas":"Belum Lunas"}function Fn(e){const t=dn(e);return`<span class="keberangkatan-payment-badge ${t==="Lunas"?"is-paid":"is-unpaid"}">${u(t)}</span>`}function Gn(e){return Hn[e]||Hn[$t]}function mt(e){return Ts.includes(e)?e:sn}function Rs(){const e=Number(document.getElementById("keberangkatan-tarif-penumpang")?.value||0),t=Number(document.getElementById("keberangkatan-uang-paket")?.value||0),n=Number(document.getElementById("keberangkatan-jumlah-snack")?.value||0),a=Number(document.getElementById("keberangkatan-pengembalian-snack")?.value||0),o=Number(document.getElementById("keberangkatan-jumlah-air-mineral")?.value||0),r=e,s=r+t,i=s*.15,c=s*.85;return{jumlah_uang_penumpang:r,uang_paket:t,total:s,uang_pc:i,uang_bersih:c,jumlah_snack:n,pengembalian_snack:a,jumlah_air_mineral:o}}function ln(){const e=Rs();Object.entries(e).forEach(([t,n])=>{const a=document.querySelector(`[data-calc="${t}"]`);if(a){if(t==="jumlah_snack"){a.textContent=`${P(n)} item`;return}if(t==="pengembalian_snack"){a.textContent=`${P(n)} item`;return}if(t==="jumlah_air_mineral"){a.textContent=`${P(n)} botol`;return}a.textContent=G(n)}})}function pt(e,t,n,a,o=""){const r=document.getElementById(e);if(!r)return;const s=e==="keberangkatan-kode-mobil"?"Pilih mobil":"Pilih driver";r.innerHTML=`
        ...
        `).join("")}
    `}function gt(e){const t=document.getElementById("keberangkatan-submit-btn");_.isSubmitting=e,t&&(t.disabled=e,t.textContent=e?"Menyimpan...":_.editItem?"Perbarui":"Simpan")}function Ps(){const e=document.getElementById("keberangkatan-table-body"),t=document.getElementById("keberangkatan-mobile-list");e&&(e.innerHTML=`
        <tr>
    ...
    `,t&&(t.hidden=!1,t.innerHTML=`
        ...
        `))}function Vn(){const e=document.getElementById("keberangkatan-table-body"),t=document.getElementById("keberangkatan-mobile-list");if(e){if(_.loading){Ps();return}if(_.data.length===0){Ds();return}e.innerHTML=_.data.map(n=>`
        <tr class="keberangkatan-row" data-testid="keberangkatan-row-${n.id}">
            ...
            <td class="text-right">${P(n.jumlah_penumpang)}</td>
            <td class="text-right keberangkatan-money-cell">${G(n.jumlah_uang_penumpang)}</td>
            <td class="text-right">${P(n.jumlah_paket)}</td>
            <td class="text-right keberangkatan-money-cell">${G(n.uang_paket)}</td>
            <td class="text-right"><span class="keberangkatan-stock-badge">${P(n.jumlah_snack)}</span></td>
            <td class="text-right"><span class="keberangkatan-stock-badge keberangkatan-stock-badge-blue">${P(n.pengembalian_snack)}</span></td>
            <td class="text-right"><span class="keberangkatan-stock-badge keberangkatan-stock-badge-blue">${P(n.jumlah_air_mineral)}</span></td>
            ...
            <td class="text-center">
                <span class="keberangkatan-trip-badge">#${P(n.trip_ke)}</span>
            </td>
            <td>
    ...
    `).join(""),t&&(t.hidden=!1,t.innerHTML=_.data.map(n=>`
            <article class="keberangkatan-mobile-card" data-testid="keberangkatan-card-${n.id}">
                ...
                <div class="keberangkatan-mobile-grid">
                    ...
                    <div class="keberangkatan-mobile-item">
                        <span>Penumpang</span>
                        <strong>${P(n.jumlah_penumpang)}</strong>
                    </div>
                    <div class="keberangkatan-mobile-item">
                        <span>Paket</span>
                        <strong>${P(n.jumlah_paket)}</strong>
                    </div>
                    <div class="keberangkatan-mobile-item">
                        <span>Snack</span>
                        <strong>${P(n.jumlah_snack)} item</strong>
                    </div>
                    <div class="keberangkatan-mobile-item">
                        <span>Pengembalian Snack</span>
                        <strong>${P(n.pengembalian_snack)} item</strong>
                    </div>
                    <div class="keberangkatan-mobile-item">
                        <span>Air Mineral</span>
                        <strong>${P(n.jumlah_air_mineral)} botol</strong>
                    </div>
        ...
        `).join(""))}}function Jn(){const e=document.getElementById("keberangkatan-pagination-shell"),t=document.getElementById("keberangkatan-pagination-info"),n=document.getElementById("keberangkatan-pagination-page"),a=document.getElementById("keberangkatan-prev-page-btn"),o=document.getElementById("keberangkatan-next-page-btn"),r=Math.max(1,Math.ceil(_.totalCount/He));e&&(e.hidden=r<=1),t&&(t.textContent=ye(_.page,He,_.totalCount,_.data.length)),n&&(n.textContent=`${_.page} / ${r}`),a&&(a.disabled=_.page===1),o&&(o.disabled=_.page>=r)}async function we(){_.loading=!0,Vn(),Jn();try{const[e,t,n,a]=await Promise.all([v(`/keberangkatan?page=${_.page}&limit=${He}${_.search?`&search=${encodeURIComponent(_.search)}`:""}`),v(`/keberangkatan/count${_.search?`?search=${encodeURIComponent(_.search)}`:""}`),v("/drivers/all"),v("/mobil/all")]);_.data=Array.isArray(e)?e:[],_.totalCount=Number(t.count||0),_.drivers=Array.isArray(n)?n:[],_.mobilList=Array.isArray(a)?a:[]}finally{_.loading=!1,Vn(),Jn()}}function Ga(){document.getElementById("keberangkatan-form")?.scrollTo({top:0,behavior:"auto"})}function Rt(){const e=document.getElementById("keberangkatan-form"),t=document.getElementById("keberangkatan-form-title"),n=document.getElementById("keberangkatan-form-description"),a=document.getElementById("keberangkatan-tanggal"),o=document.getElementById("keberangkatan-jam-keberangkatan"),r=document.getElementById("keberangkatan-trip-ke"),s=document.getElementById("keberangkatan-tipe-layanan"),i=document.getElementById("keberangkatan-jumlah-penumpang"),c=document.getElementById("keberangkatan-tarif-penumpang"),d=document.getElementById("keberangkatan-jumlah-paket"),l=document.getElementById("keberangkatan-uang-paket"),f=document.getElementById("keberangkatan-jumlah-snack"),E=document.getElementById("keberangkatan-pengembalian-snack"),M=document.getElementById("keberangkatan-jumlah-air-mineral"),b=document.getElementById("keberangkatan-status-pembayaran");e?.reset(),_.editItem=null,document.getElementById("keberangkatan-id").value="",t&&(t.textContent="Tambah Data Keberangkatan"),n&&(n.textContent="Isi form di bawah untuk menambahkan data keberangkatan"),a&&(a.value=Ze()),o&&(o.value=$t),pt("keberangkatan-kode-mobil",_.mobilList,"kode_mobil",k=>`${k.kode_mobil} - ${k.jenis_mobil}`,_.mobilList[0]?.kode_mobil||""),pt("keberangkatan-driver-id",_.drivers,"id",k=>`${k.nama} - ${k.lokasi}`,_.drivers[0]?.id||""),r&&(r.value="1"),s&&(s.value=sn),i&&(i.value="0"),c&&(c.value="0"),d&&(d.value="0"),l&&(l.value="0"),f&&(f.value="0"),E&&(E.value="0"),M&&(M.value="0"),b&&(b.value="Belum Lunas"),gt(!1),ln(),Ga()}async function Kn(e){const t=await v(`/keberangkatan/${e}`),n=document.getElementById("keberangkatan-form-title"),a=document.getElementById("keberangkatan-form-description");_.editItem=t,document.getElementById("keberangkatan-id").value=t.id,document.getElementById("keberangkatan-tanggal").value=t.tanggal,document.getElementById("keberangkatan-jam-keberangkatan").value=t.jam_keberangkatan||$t,document.getElementById("keberangkatan-trip-ke").value=t.trip_ke,document.getElementById("keberangkatan-tipe-layanan").value=mt(t.tipe_layanan),document.getElementById("keberangkatan-jumlah-penumpang").value=t.jumlah_penumpang,document.getElementById("keberangkatan-tarif-penumpang").value=t.tarif_penumpang,document.getElementById("keberangkatan-jumlah-paket").value=t.jumlah_paket,document.getElementById("keberangkatan-uang-paket").value=t.uang_paket,document.getElementById("keberangkatan-jumlah-snack").value=t.jumlah_snack,document.getElementById("keberangkatan-pengembalian-snack").value=t.pengembalian_snack,document.getElementById("keberangkatan-jumlah-air-mineral").value=t.jumlah_air_mineral,document.getElementById("keberangkatan-status-pembayaran").value=dn(t.status_pembayaran),pt("keberangkatan-kode-mobil",_.mobilList,"kode_mobil",o=>`${o.kode_mobil} - ${o.jenis_mobil}`,t.kode_mobil),pt("keberangkatan-driver-id",_.drivers,"id",o=>`${o.nama} - ${o.lokasi}`,t.driver_id),n&&(n.textContent="Edit Data Keberangkatan"),a&&(a.textContent="Isi form di bawah untuk memperbarui data keberangkatan"),gt(!1),ln(),Ga(),N("keberangkatan-form-modal")}function zn(e){_.deleteItem=e,N("keberangkatan-delete-modal")}function Os(){const e=document.getElementById("keberangkatan-add-btn"),t=document.getElementById("keberangkatan-export-btn"),n=document.getElementById("keberangkatan-search-input"),a=document.getElementById("keberangkatan-form"),o=document.getElementById("keberangkatan-table-body"),r=document.getElementById("keberangkatan-mobile-list"),s=document.getElementById("keberangkatan-delete-confirm-btn"),i=document.getElementById("keberangkatan-prev-page-btn"),c=document.getElementById("keberangkatan-next-page-btn");if(!(!e||!a||!o))return e.addEventListener("click",()=>{Rt(),N("keberangkatan-form-modal")}),t?.addEventListener("click",()=>{tn("/export/keberangkatan/csv","keberangkatan.csv").catch(()=>{y("Gagal mengunduh file")})}),n?.addEventListener("input",he(async d=>{_.search=d.target.value.trim(),_.page=1;try{await we()}catch{y("Gagal memuat data")}})),a.addEventListener("input",d=>{["keberangkatan-jumlah-penumpang","keberangkatan-tarif-penumpang","keberangkatan-uang-paket","keberangkatan-jumlah-snack","keberangkatan-pengembalian-snack","keberangkatan-jumlah-air-mineral"].includes(d.target.id)&&ln()}),a.addEventListener("submit",async d=>{d.preventDefault();const l={tanggal:document.getElementById("keberangkatan-tanggal")?.value||"",jam_keberangkatan:document.getElementById("keberangkatan-jam-keberangkatan")?.value||$t,tipe_layanan:mt(document.getElementById("keberangkatan-tipe-layanan")?.value||sn),kode_mobil:document.getElementById("keberangkatan-kode-mobil")?.value||"",driver_id:document.getElementById("keberangkatan-driver-id")?.value||"",jumlah_penumpang:Number(document.getElementById("keberangkatan-jumlah-penumpang")?.value||0),tarif_penumpang:Number(document.getElementById("keberangkatan-tarif-penumpang")?.value||0),jumlah_paket:Number(document.getElementById("keberangkatan-jumlah-paket")?.value||0),uang_paket:Number(document.getElementById("keberangkatan-uang-paket")?.value||0),jumlah_snack:Number(document.getElementById("keberangkatan-jumlah-snack")?.value||0),pengembalian_snack:Number(document.getElementById("keberangkatan-pengembalian-snack")?.value||0),jumlah_air_mineral:Number(document.getElementById("keberangkatan-jumlah-air-mineral")?.value||0),trip_ke:Number(document.getElementById("keberangkatan-trip-ke")?.value||1),status_pembayaran:dn(document.getElementById("keberangkatan-status-pembayaran")?.value||"")};gt(!0);try{_.editItem?(await v(`/keberangkatan/${_.editItem.id}`,{method:"PUT",body:l}),U("Data berhasil diperbarui")):(await v("/keberangkatan",{method:"POST",body:l}),U("Data berhasil ditambahkan")),Z("keberangkatan-form-modal"),Rt(),await we()}catch(f){y(f.message||"Silakan periksa input Anda","Gagal menyimpan data")}finally{gt(!1)}}),o.addEventListener("click",async d=>{const l=d.target.closest("[data-keberangkatan-edit]"),f=d.target.closest("[data-keberangkatan-delete]");try{if(l){await Kn(l.dataset.keberangkatanEdit);return}f&&zn({id:f.dataset.keberangkatanDelete})}catch{y("Gagal memuat data")}}),r?.addEventListener("click",async d=>{const l=d.target.closest("[data-keberangkatan-edit]"),f=d.target.closest("[data-keberangkatan-delete]");try{if(l){await Kn(l.dataset.keberangkatanEdit);return}f&&zn({id:f.dataset.keberangkatanDelete})}catch{y("Gagal memuat data")}}),s?.addEventListener("click",async()=>{if(_.deleteItem)try{await v(`/keberangkatan/${_.deleteItem.id}`,{method:"DELETE"}),U("Data berhasil dihapus"),Z("keberangkatan-delete-modal"),(_.page-1)*He>=_.totalCount-1&&_.page>1&&(_.page-=1),_.deleteItem=null,await we()}catch{y("Gagal menghapus data")}}),i?.addEventListener("click",async()=>{if(!(_.page<=1)){_.page-=1;try{await we()}catch{y("Gagal memuat data")}}}),c?.addEventListener("click",async()=>{const d=Math.max(1,Math.ceil(_.totalCount/He));if(!(_.page>=d)){_.page+=1;try{await we()}catch{y("Gagal memuat data")}}}),we().then(()=>{Rt()}).catch(()=>{y("Gagal memuat data")})}const C={data:[],loading:!0,totalCount:0,page:1,search:"",editItem:null,deleteItem:null,isSubmitting:!1,prices:{snack:0,air:0}},Fe=10;function js(){return`
        <svg viewBox="0 0 24 24" fill="none">
            <path d="M4 20H8L18.5 9.5C19.3284 8.67157 19.3284 7.32843 18.5 6.5V6.5C17.6716 5.67157 16.3284 5.67157 15.5 6.5L5 17V20Z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"></path>
            <path d="M13.5 8.5L16.5 11.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path>
        </svg>
    ...
    `,t&&(t.hidden=!1,t.innerHTML=`
        ...
        <tr class="stock-row" data-testid="stock-row-${n.id}">
            ...
            <td>${u(n.tanggal)}</td>
            <td>${u(n.bulan)}</td>
            <td class="text-right">${P(n.total_stock_snack_display??n.total_stock_snack)}</td>
            <td class="text-right">${P(n.total_stock_air_mineral)}</td>
            <td class="text-right">${P(n.pengembalian_snack)}</td>
            <td class="text-right">${P(n.terpakai_snack)}</td>
            <td class="text-right">${P(n.terpakai_air_mineral)}</td>
            <td class="text-right"><span class="stock-value-badge stock-value-badge-emerald">${P(n.sisa_stock_snack)}</span></td>
            <td class="text-right"><span class="stock-value-badge stock-value-badge-blue">${P(n.sisa_stock_air_mineral)}</span></td>
            ...
            <article class="stock-mobile-card" data-testid="stock-card-${n.id}">
                ...
                <div class="stock-mobile-grid">
                    <div class="stock-mobile-item">
                        ...
                        <strong>${P(n.total_stock_snack_display??n.total_stock_snack)}</strong>
                    </div>
                    <div class="stock-mobile-item">
                        <span>Total Air Mineral</span>
                        <strong>${P(n.total_stock_air_mineral)}</strong>
                    </div>
                    <div class="stock-mobile-item">
                        <span>Pengembalian Snack</span>
                        <strong>${P(n.pengembalian_snack)}</strong>
                    </div>
                    <div class="stock-mobile-item">
                        <span>Terpakai Snack</span>
                        <strong>${P(n.terpakai_snack)}</strong>
                    </div>
                    <div class="stock-mobile-item">
                        <span>Terpakai Air Mineral</span>
                        <strong>${P(n.terpakai_air_mineral)}</strong>
                    </div>
                    <div class="stock-mobile-item">
                        <span>Sisa Snack</span>
                        <strong>${P(n.sisa_stock_snack)}</strong>
                    </div>
                    <div class="stock-mobile-item">
                        <span>Sisa Air Mineral</span>
                        <strong>${P(n.sisa_stock_air_mineral)}</strong>
                    </div>
    ...
    `)}async function ti(e){ei(await v(`/admin-users/${e}`)),N("admin-user-show-modal")}async function ni(e){Ys(await v(`/admin-users/${e}`)),N("admin-user-form-modal")}function ai(e){x.deleteItem=e,document.getElementById("admin-user-delete-copy").innerHTML=`Apakah Anda yakin ingin menghapus akun <strong>${u(e.nama)}</strong>? Tindakan ini tidak dapat dibatalkan.`,N("admin-user-delete-modal")}function ta(){const e=document.getElementById("admin-users-access-note"),t=document.getElementById("admin-users-search-input"),n=document.querySelector(".admin-users-page-actions");e&&(e.hidden=!1,e.textContent="Halaman ini hanya dapat diakses oleh Admin atau Super Admin."),t&&(t.disabled=!0),n&&(n.hidden=!0),x.loading=!1,x.data=[],x.totalCount=0,Va("Anda tidak memiliki akses untuk mengelola data admin dan user."),Vt()}function oi({user:e}={}){const t=document.getElementById("admin-users-add-admin-btn"),n=document.getElementById("admin-users-add-user-btn"),a=document.getElementById("admin-users-search-input"),o=document.getElementById("admin-user-form"),r=document.getElementById("admin-users-table-body"),s=document.getElementById("admin-user-delete-confirm-btn"),i=document.getElementById("admin-users-prev-page-btn"),c=document.getElementById("admin-users-next-page-btn");if(!(!t||!n||!o||!r)){if(x.currentUser=e||window.transitAuthUser||null,!Gs(x.currentUser?.role)){ta();return}return t.addEventListener("click",()=>{Pt("Admin"),N("admin-user-form-modal")}),n.addEventListener("click",()=>{Pt("User"),N("admin-user-form-modal")}),a?.addEventListener("input",he(async d=>{x.search=d.target.value.trim(),x.page=1;try{await Ie()}catch(l){y(l.message||"Gagal memuat data akun")}})),o.addEventListener("submit",async d=>{d.preventDefault();const l={nama:document.getElementById("admin-user-nama")?.value.trim()||"",username:document.getElementById("admin-user-username")?.value.trim()||"",email:document.getElementById("admin-user-email")?.value.trim()||"",password:document.getElementById("admin-user-password")?.value||"",role:document.getElementById("admin-user-role")?.value||"User"};ht(!0);try{x.editItem?(await v(`/admin-users/${x.editItem.id}`,{method:"PUT",body:l}),U("Akun berhasil diperbarui")):(await v("/admin-users",{method:"POST",body:l}),U(l.role==="Admin"?"Admin berhasil ditambahkan":"User berhasil ditambahkan")),Z("admin-user-form-modal"),Pt(x.defaultRole),await Ie()}catch(f){y(f.message||"Silakan periksa kembali data yang diinput","Gagal menyimpan akun")}finally{ht(!1)}}),r.addEventListener("click",async d=>{const l=d.target.closest("[data-admin-user-show]"),f=d.target.closest("[data-admin-user-edit]"),E=d.target.closest("[data-admin-user-delete]");try{if(l){await ti(l.dataset.adminUserShow);return}if(f){await ni(f.dataset.adminUserEdit);return}E&&ai({id:E.dataset.adminUserDelete,nama:E.dataset.adminUserName})}catch(M){y(M.message||"Gagal memuat detail akun")}}),s?.addEventListener("click",async()=>{if(x.deleteItem)try{await v(`/admin-users/${x.deleteItem.id}`,{method:"DELETE"}),U("Akun berhasil dihapus"),Z("admin-user-delete-modal"),(x.page-1)*Ge>=x.totalCount-1&&x.page>1&&(x.page-=1),x.deleteItem=null,await Ie()}catch(d){y(d.message||"Gagal menghapus akun")}}),i?.addEventListener("click",async()=>{if(!(x.page<=1)){x.page-=1;try{await Ie()}catch(d){y(d.message||"Gagal memuat data akun")}}}),c?.addEventListener("click",async()=>{const d=Math.max(1,Math.ceil(x.totalCount/Ge));if(!(x.page>=d)){x.page+=1;try{await Ie()}catch(l){y(l.message||"Gagal memuat data akun")}}}),Ie().catch(d=>{if(d.status===403){ta();return}y(d.message||"Gagal memuat data akun")})}}const na=[{value:"05:00",label:"Subuh",time:"05.00 WIB"},{value:"08:00",label:"Pagi",time:"08.00 WIB"},{value:"10:00",label:"Pagi",time:"10.00 WIB"},{value:"14:00",label:"Siang",time:"14.00 WIB"},{value:"16:00",label:"Sore",time:"16.00 WIB"},{value:"19:00",label:"Malam",time:"19.00 WIB"}],za=[[{code:"1A",label:"1A"},{code:"SOPIR",label:"SOPIR",isDriver:!0}],[{code:"2A",label:"2A"},{code:"3A",label:"3A"}],[{code:"4A",label:"4A"},{code:"5A",label:"5A"}]],aa=za.flat().filter(e=>!e.isDriver).length,g={currentUser:null,date:Ze(),direction:"from_pkb",bookings:[],loading:!1,drivers:[],mobils:[],formOptions:null,selectedSeats:[],passengerDraftMap:{},editItem:null,deleteItem:null,slotDriverMap:{},slotMobilMap:{},occupiedSeatsForForm:[],occupiedSeatsForPackageForm:[],slotExtraArmadas:{},currentFormArmadaIndex:1,_pendingChoiceArmada:1,_pendingChoiceTime:""};function Dt(e){const t=document.getElementById(e);if(!t)return null;try{return JSON.parse(t.textContent||"{}")}catch{return null}}function ri(e){return["Super Admin","Admin"].includes(e)}function si(e){const t=e?"#dc2626":"#166534",n=e?"#991b1b":"#14532d";return`
        ...
        </div>`}function gi(e){const t={};return e.forEach(n=>{(Array.isArray(n.selected_seats)?n.selected_seats:[]).forEach(o=>{t[o]||(t[o]=n)})}),t}function fi(e,t,n,a){const o=gi(n),r=n.reduce((p,h)=>p+(Number(h.passenger_count)||0),0),s=r>=aa,i=`${e.value}__${g.direction}__${t}`;if(!g.slotDriverMap[i]){const p=n.find(h=>h.driver_id);p&&(g.slotDriverMap[i]=p.driver_id)}const c=g.slotDriverMap[i]||"",d=g.slotMobilMap[i]||"",l=s?"stock-value-badge-red":"stock-value-badge-yellow",f=g.drivers.map(p=>{const h=p.lokasi?`${p.nama} (${p.lokasi})`:p.nama;return`<option value="${u(p.id)}" ${c===p.id?"selected":""}>${u(h)}</option>`}).join(""),E=g.mobils.map(p=>{const h=`${p.kode_mobil} — ${p.jenis_mobil}`;return`<option value="${u(p.id)}" ${d===p.id?"selected":""}>${u(h)}</option>`}).join(""),M=[...new Set(n.map(p=>(p.service_type||"").trim()).filter(Boolean))],b=a>1?`<span class="bpg-armada-badge">${ci()} Armada ${t}</span>`:"",k=s?`<button class="bpg-add-armada-btn" type="button"
        ...
        <article class="bpg-slot-card" data-slot="${u(e.value)}" data-direction="${u(g.direction)}" data-armada="${t}">
                ...
                <div class="bpg-slot-head-row">
                    ...
                    <div class="bpg-slot-head-meta">
                        ...
                        <div class="bpg-slot-service-types">
                            ${M.length>0?M.map(p=>`<span class="bpg-service-badge">${u(p)}</span>`).join(""):'<span class="bpg-service-badge bpg-service-badge--empty">Belum ada layanan</span>'}
                        </div>
        ...
        </article>`}function bi(e,t){const n={};t.forEach(c=>{const d=c.armada_index||1;n[d]||(n[d]=[]),n[d].push(c)});const a=`${e.value}__${g.direction}`,o=t.length>0?Math.max(...Object.keys(n).map(Number)):1,r=g.slotExtraArmadas[a]||1,s=Math.max(o,r),i=[];for(let c=1;c<=s;c++)i.push(fi(e,c,n[c]||[],s));return`<div class="bpg-slot-group" data-slot-group="${u(e.value)}">${i.join("")}</div>`}function ki(){const e=document.getElementById("bpg-slots-shell");e&&(e.innerHTML=`
            <div class="admin-users-loading-inline" style="padding:40px 0;">
                <span class="admin-users-loading-inline-spinner" aria-hidden="true"></span>
                <span>Memuat data penumpang...</span>
            </div>`)}function Wa(){const e=document.getElementById("bpg-slots-shell");if(!e)return;const t={};na.forEach(a=>{t[a.value]=[]}),g.bookings.forEach(a=>{const r=(a.trip_time||"").trim().substring(0,5);t[r]&&t[r].push(a)});const n=na.map(a=>bi(a,t[a.value]||[]));e.innerHTML=`<div class="bpg-slots-grid">${n.join("")}</div>`}async function _e(){g.loading=!0,ki();try{const e=new URLSearchParams({date:g.date,direction:g.direction,limit:200,page:1}),[t,n]=await Promise.all([v(`/bookings?${e}`),v(`/bookings/armada-extras?date=${g.date}`).catch(()=>({}))]);g.bookings=Array.isArray(t)?t:[],n&&typeof n=="object"&&Object.entries(n).forEach(([a,o])=>{const r=`${a}__${g.direction}`;g.slotExtraArmadas[r]=Math.max(g.slotExtraArmadas[r]||1,Number(o)||1)})}catch(e){g.bookings=[],e.status!==403&&y(e.message||"Gagal memuat data penumpang")}finally{g.loading=!1,Wa()}}function ra(e){return{Aktif:"green",Selesai:"green",Dibayar:"green","Dibayar Tunai":"green",Draft:"gray","Belum Bayar":"orange","Menunggu Pembayaran":"blue","Menunggu Verifikasi":"blue","Menunggu Konfirmasi":"blue",Batal:"red",Reguler:"purple",Paket:"blue"}[e]||"gray"}function hi(e){document.getElementById("bpg-detail-title").textContent=e.nama_pemesanan||"-",document.getElementById("bpg-detail-subtitle").textContent=e.booking_code||"-",document.getElementById("bpg-detail-full-link").href=`/dashboard/bookings/${e.id}`;const t=e.category==="Paket",n=document.getElementById("bpg-detail-ticket-link"),a=document.getElementById("bpg-detail-surat-link");t?(n.hidden=!0,a.hidden=!1,a.href=`/dashboard/bookings/${e.id}/surat-bukti`):(n.hidden=!1,n.href=`/unduh/tiket-reguler/${e.booking_code}`,a.hidden=!0);const o=e.booking_status||"",r=e.payment_status||"",s=e.service_type||"",i=(e.pickup_location||"").trim()!=="",c=(e.dropoff_location||"").trim()!=="",d=document.getElementById("bpg-detail-body");d.innerHTML=`
        <!-- Status Badges -->
    ...
    `,N("bpg-detail-modal")}function yi(){return(g.formOptions?.seat_options||[]).map(e=>e.code)}function cn(e){const t=new Map(yi().map((n,a)=>[n,a]));return Array.from(new Set((e||[]).map(n=>String(n).trim()).filter(n=>t.has(n)))).sort((n,a)=>(t.get(n)??999)-(t.get(a)??999))}function St(){return Number(document.getElementById("booking-passenger-count")?.value||0)}function vi(){const e=St();return(g.formOptions?.seat_options||[]).filter(t=>!t.is_optional||e>=6).map(t=>t.code)}function Ei(){return g.formOptions?.payment_status_options||[]}function wi(e){return e==="transfer"?["Belum Bayar","Menunggu Pembayaran","Menunggu Verifikasi","Dibayar"]:e==="qris"?["Belum Bayar","Menunggu Pembayaran","Dibayar"]:e==="cash"?["Belum Bayar","Dibayar Tunai"]:["Belum Bayar"]}function Bi(e){return e==="transfer"?"Menunggu Pembayaran":e==="qris"?"Dibayar":e==="cash"?"Dibayar Tunai":"Belum Bayar"}function Ii(e){return e==="transfer"?"Menunggu Verifikasi Pembayaran":e==="qris"||e==="cash"?"Diproses":"Draft"}function _i(e,t){if(!e||!t||e===t)return null;const a=(g.formOptions?.route_matrix||{})?.[e]?.[t];return a==null?null:Number(a)}function Xa(){return Math.max(0,parseInt(document.getElementById("booking-additional-fare")?.value||"0",10)||0)}function Se(){const e=document.getElementById("booking-from-city")?.value||"",t=document.getElementById("booking-to-city")?.value||"",n=St(),a=_i(e,t),o=Xa(),r=a!==null?a+o:null,s=r!==null?r*n:null,i=document.getElementById("booking-price-per-seat"),c=document.getElementById("booking-total-amount");i&&(i.value=a!==null?G(a):""),c&&(c.value=s!==null?G(s):"")}function un(){const e=document.getElementById("booking-payment-method")?.value||"",t=document.getElementById("booking-payment-status"),n=document.getElementById("booking-booking-status"),a=document.getElementById("booking-bank-account-group"),o=document.getElementById("booking-bank-account-code"),r=wi(e),s=t?.value||"";a&&(a.hidden=e!=="transfer"),o&&e!=="transfer"&&(o.value=""),t&&(t.innerHTML=Ei().filter(i=>r.includes(i.value)).map(i=>`<option value="${u(i.value)}">${u(i.label)}</option>`).join(""),t.value=r.includes(s)?s:Bi(e)),n&&(n.value=Ii(e))}function $i(){const e=document.getElementById("booking-selected-seats-inputs");e&&(e.innerHTML=g.selectedSeats.map(t=>`<input type="hidden" name="selected_seats[]" value="${u(t)}">`).join(""))}function Si(){const e=document.getElementById("booking-selected-seat-count"),t=document.getElementById("booking-selected-seat-label");e&&(e.textContent=String(g.selectedSeats.length)),t&&(t.textContent=g.selectedSeats.length>0?g.selectedSeats.join(", "):"Belum dipilih")}function Jt(){document.querySelectorAll("[data-passenger-seat]").forEach(e=>{const t=e.dataset.passengerSeat;t&&(g.passengerDraftMap[t]={seat_no:t,name:e.querySelector("[data-passenger-name]")?.value.trim()||"",phone:e.querySelector("[data-passenger-phone]")?.value.trim()||""})})}function me(e=null){const t=document.getElementById("booking-passenger-editor");if(t){if(e&&(g.passengerDraftMap=Object.fromEntries(e.map(n=>[n.seat_no,n]))),g.selectedSeats.length===0){t.innerHTML='<div class="dashboard-empty-state dashboard-empty-state--block bookings-passenger-empty">Pilih kursi terlebih dahulu untuk menampilkan form data penumpang.</div>';return}t.innerHTML=`
        <div class="bookings-passenger-grid bookings-passenger-grid--editor">
            ${g.selectedSeats.map((n,a)=>{const o=g.passengerDraftMap[n]||{name:"",phone:""};return`
        ...
        </div>`}}async function qe(){const e=document.getElementById("booking-trip-date")?.value||"",t=document.getElementById("booking-trip-time")?.value||"",n=document.getElementById("booking-from-city")?.value||"",a=document.getElementById("booking-to-city")?.value||"",o=g.editItem?.id||"",r=g.currentFormArmadaIndex||1;if(!e||!t){g.occupiedSeatsForForm=[];return}try{const s=new URLSearchParams({trip_date:e,trip_time:t,armada_index:r});n&&s.set("from_city",n),a&&s.set("to_city",a),o&&s.set("exclude_id",o);const i=await v(`/bookings/occupied-seats?${s}`);g.occupiedSeatsForForm=Array.isArray(i?.occupied_seats)?i.occupied_seats:[]}catch{g.occupiedSeatsForForm=[]}}async function Oe(){const e=document.getElementById("pkg-trip-date")?.value||"",t=document.getElementById("pkg-trip-time")?.value||"",n=document.getElementById("pkg-from-city")?.value||"",a=document.getElementById("pkg-to-city")?.value||"",o=parseInt(document.getElementById("package-armada-index")?.value||"1",10);if(!e||!t){g.occupiedSeatsForPackageForm=[],sa();return}try{const r=new URLSearchParams({trip_date:e,trip_time:t,armada_index:o});n&&r.set("from_city",n),a&&r.set("to_city",a);const s=await v(`/bookings/occupied-seats?${r}`);g.occupiedSeatsForPackageForm=Array.isArray(s?.occupied_seats)?s.occupied_seats:[]}catch{g.occupiedSeatsForPackageForm=[]}sa()}function sa(){const e=document.getElementById("pkg-seat-code");if(!e)return;const t=(g.formOptions?.seat_options||[]).filter(o=>!o.is_optional),n=g.occupiedSeatsForPackageForm||[],a=e.value;e.innerHTML='<option value="">Pilih kursi</option>'+t.map(o=>{const r=n.includes(o.code);return`<option value="${u(o.code)}"${r?" disabled":""}>${u(o.label)}${r?" — Sudah dipesan":""}</option>`}).join(""),a&&!n.includes(a)&&(e.value=a)}function pe(){const e=document.querySelectorAll("[data-seat-code]"),t=St(),n=vi();g.selectedSeats=cn(g.selectedSeats.filter(a=>n.includes(a)&&!g.occupiedSeatsForForm.includes(a))),e.forEach(a=>{const o=a.dataset.seatCode,r=n.includes(o),s=g.occupiedSeatsForForm.includes(o),i=g.selectedSeats.includes(o),c=g.selectedSeats.length>=t&&!i;a.hidden=!r,a.classList.toggle("is-selected",i),a.classList.toggle("is-occupied",s),a.classList.toggle("is-disabled",!s&&c),a.disabled=!r||s||!i&&c,s?a.title="Kursi sudah dipesan":a.title=""}),$i(),Si()}function Ot(e=1,t=""){document.getElementById("booking-form")?.reset(),g.editItem=null,g.selectedSeats=[],g.passengerDraftMap={},g.currentFormArmadaIndex=e;const a=g.date||Ze();document.getElementById("booking-id").value="",document.getElementById("booking-armada-index").value=String(e),document.getElementById("booking-form-title").textContent="Tambah Pemesanan";const o=e>1?` (Armada ${e})`:"";document.getElementById("booking-form-description").textContent=`Lengkapi data pemesanan reguler dari dashboard admin${o}.`,document.getElementById("booking-trip-date").value=a,document.getElementById("booking-trip-time").value=t||"";const r=document.getElementById("booking-from-city"),s=document.getElementById("booking-to-city");r&&(r.value=""),s&&(s.value=""),document.getElementById("booking-passenger-count").value="1",document.getElementById("booking-additional-fare").value="0",document.getElementById("booking-payment-method").value="",document.getElementById("booking-booking-status").value="Draft",un(),Se(),se(document.getElementById("booking-submit-btn"),!1,"Menyimpan..."),qe().then(()=>{pe(),me()})}function Ci(e){g.editItem=e,g.selectedSeats=cn(e.selected_seats||[]),g.passengerDraftMap=Object.fromEntries((e.passengers||[]).map(n=>[n.seat_no,n])),g.currentFormArmadaIndex=e.armada_index||1,document.getElementById("booking-id").value=e.id,document.getElementById("booking-armada-index").value=String(e.armada_index||1),document.getElementById("booking-booking-for").value=e.booking_for,document.getElementById("booking-category").value=e.category,document.getElementById("booking-from-city").value=e.from_city,document.getElementById("booking-to-city").value=e.to_city,document.getElementById("booking-trip-date").value=e.trip_date_value,document.getElementById("booking-trip-time").value=e.trip_time_value,document.getElementById("booking-passenger-count").value=String(e.passenger_count),document.getElementById("booking-driver-name").value=e.driver_name==="Menunggu Penetapan Driver"?"":e.driver_name||"",document.getElementById("booking-additional-fare").value=String(e.additional_fare_per_passenger||0),document.getElementById("booking-pickup-location").value=e.pickup_location,document.getElementById("booking-dropoff-location").value=e.dropoff_location,document.getElementById("booking-payment-method").value=e.payment_method_value||"",un(),document.getElementById("booking-payment-status").value=e.payment_status,document.getElementById("booking-booking-status").value=e.booking_status,document.getElementById("booking-bank-account-code").value=e.bank_account_code||"",document.getElementById("booking-notes").value=e.notes||"";const t=(e.armada_index||1)>1?` (Armada ${e.armada_index})`:"";document.getElementById("booking-form-title").textContent="Edit Pemesanan",document.getElementById("booking-form-description").textContent=`Perbarui data pemesanan reguler yang dipilih${t}.`,Se(),se(document.getElementById("booking-submit-btn"),!1,"Menyimpan..."),qe().then(()=>{pe(),me(e.passengers||[])})}function xi(){return Jt(),{booking_for:document.getElementById("booking-booking-for")?.value||"",category:document.getElementById("booking-category")?.value||"Reguler",from_city:document.getElementById("booking-from-city")?.value||"",to_city:document.getElementById("booking-to-city")?.value||"",trip_date:document.getElementById("booking-trip-date")?.value||"",trip_time:document.getElementById("booking-trip-time")?.value||"",passenger_count:Number(document.getElementById("booking-passenger-count")?.value||0),driver_name:document.getElementById("booking-driver-name")?.value.trim()||"",additional_fare_per_passenger:Xa(),pickup_location:document.getElementById("booking-pickup-location")?.value.trim()||"",dropoff_location:document.getElementById("booking-dropoff-location")?.value.trim()||"",selected_seats:g.selectedSeats,passengers:g.selectedSeats.map(e=>({seat_no:e,name:g.passengerDraftMap?.[e]?.name||"",phone:g.passengerDraftMap?.[e]?.phone||""})),payment_method:document.getElementById("booking-payment-method")?.value||"",payment_status:document.getElementById("booking-payment-status")?.value||"Belum Bayar",booking_status:document.getElementById("booking-booking-status")?.value||"Draft",bank_account_code:document.getElementById("booking-bank-account-code")?.value||"",notes:document.getElementById("booking-notes")?.value.trim()||"",armada_index:g.currentFormArmadaIndex||1}}async function Li(e){Ci(await v(`/bookings/${e}`)),N("booking-form-modal")}function Ti(e){g.deleteItem=e,document.getElementById("booking-delete-copy").innerHTML=`Apakah Anda yakin ingin menghapus data pemesanan <strong>${u(e.nama)}</strong>? Tindakan ini tidak dapat dibatalkan.`,N("booking-delete-modal")}function ia(){const e=document.getElementById("bookings-access-note"),t=document.getElementById("bpg-route-tabs"),n=document.getElementById("bpg-slots-shell");e&&(e.hidden=!1),t&&(t.hidden=!0),n&&(n.hidden=!0)}function Ai(e){return e==="Berangkat"?{label:"Berangkat",cls:"bpg-depart-trigger--go"}:e==="Tidak Berangkat"?{label:"Tidak Berangkat",cls:"bpg-depart-trigger--no"}:e==="Di Oper"?{label:"Di Oper",cls:"bpg-depart-trigger--oper"}:{label:"Status",cls:""}}function Mi({user:e}={}){const t=document.getElementById("bookings-add-btn"),n=document.getElementById("bookings-date-picker"),a=document.getElementById("bpg-route-tabs"),o=document.getElementById("bpg-slots-shell"),r=document.getElementById("booking-form"),s=document.getElementById("booking-delete-confirm-btn"),i=document.getElementById("booking-seat-grid"),c=document.getElementById("booking-passenger-editor"),d=document.getElementById("booking-payment-method");if(g.formOptions=Dt("bookings-form-options"),g.drivers=Dt("bookings-drivers-data")||[],g.mobils=Dt("bookings-mobils-data")||[],g.currentUser=e||window.transitAuthUser||null,g.date=Ze(),!ri(g.currentUser?.role)){ia();return}o&&(o.hidden=!1);const l=document.getElementById("bookings-access-note");l&&(l.hidden=!0),n&&(n.value=g.date,n.addEventListener("change",async()=>{g.date=n.value,g.slotDriverMap={},g.slotMobilMap={},g.slotExtraArmadas={},await _e()})),a?.addEventListener("click",async p=>{const h=p.target.closest("[data-direction]");if(!h)return;const w=h.dataset.direction;w!==g.direction&&(g.direction=w,g.slotDriverMap={},g.slotMobilMap={},g.slotExtraArmadas={},document.querySelectorAll(".bpg-route-tab").forEach($=>{$.classList.toggle("is-active",$.dataset.direction===w)}),await _e())});function f(p=null){o?.querySelectorAll("[data-depart-dropdown]").forEach(h=>{String(h.dataset.departDropdown)!==String(p)&&(h.querySelector(".bpg-depart-menu")?.removeAttribute("hidden"),h.querySelector(".bpg-depart-menu")?.setAttribute("hidden",""))})}document.addEventListener("click",p=>{p.target.closest("[data-depart-dropdown]")||f()}),o?.addEventListener("click",async p=>{const h=p.target.closest("[data-depart-toggle]"),w=p.target.closest("[data-booking-departure]"),$=p.target.closest("[data-booking-lihat]"),R=p.target.closest("[data-booking-edit]"),O=p.target.closest("[data-booking-delete]"),H=p.target.closest("[data-add-armada]"),D=p.target.closest("[data-slot-book]"),X=p.target.closest("[data-surat-jalan]");try{if(h){const j=h.dataset.departToggle,J=o.querySelector(`[data-depart-dropdown="${CSS.escape(j)}"]`)?.querySelector(".bpg-depart-menu");if(!J)return;const B=J.hasAttribute("hidden");f(j),J.toggleAttribute("hidden",!B);return}if(w){const j=w.dataset.bookingDeparture,z=w.dataset.departureStatus,J=g.bookings.find(K=>String(K.id)===String(j));if(!J)return;const B=J.departure_status===z?"":z;J.departure_status=B;const q=o.querySelector(`[data-depart-dropdown="${CSS.escape(j)}"]`);if(q){const K=q.querySelector(".bpg-depart-trigger"),ne=Ai(B);K.className=`bpg-depart-trigger ${ne.cls}`,K.childNodes.forEach(V=>{V.nodeType===3&&(V.textContent=ne.label)}),q.querySelectorAll("[data-booking-departure]").forEach(V=>{V.classList.toggle("is-active",V.dataset.departureStatus===B)}),q.querySelector(".bpg-depart-menu")?.setAttribute("hidden","")}await v(`/bookings/${j}/departure-status`,{method:"PATCH",body:{departure_status:B}});return}if($){const j=$.dataset.bookingLihat,z=g.bookings.find(J=>String(J.id)===String(j));z&&hi(z);return}if(R){await Li(R.dataset.bookingEdit);return}if(O){Ti({id:O.dataset.bookingDelete,nama:O.dataset.bookingName});return}if(H){const j=H.dataset.addArmada,J=parseInt(H.dataset.armadaIndex||"1")+1,B=`${j}__${g.direction}`;g.slotExtraArmadas[B]=Math.max(g.slotExtraArmadas[B]||1,J),v("/bookings/armada-extras",{method:"POST",body:{trip_date:g.date,trip_time:j,armada_index:J}}).catch(()=>{}),Wa(),g._pendingChoiceArmada=J,g._pendingChoiceTime=j,N("booking-type-choice-modal");return}if(D){const j=D.dataset.slotBook,z=parseInt(D.dataset.slotArmada||"1");g._pendingChoiceArmada=z,g._pendingChoiceTime=j,N("booking-type-choice-modal");return}if(X){const j=X.dataset.suratJalan,z=parseInt(X.dataset.suratJalanArmada||"1"),J=`${j}__${g.direction}__${z}`,B=g.slotDriverMap[J]||"",q=g.slotMobilMap[J]||"",K=B?g.drivers.find(Y=>String(Y.id)===String(B)):null,ne=q?g.mobils.find(Y=>String(Y.id)===String(q)):null,V=new URLSearchParams({date:g.date,trip_time:j,armada_index:String(z),direction:g.direction});K&&V.set("driver_name",K.nama),ne&&V.set("no_pol",ne.kode_mobil),window.open(`/dashboard/bookings/surat-jalan?${V}`,"_blank");return}}catch(j){y(j.message||"Gagal memuat data pemesanan")}}),o?.addEventListener("change",async p=>{const h=p.target.closest("[data-slot-driver]"),w=p.target.closest("[data-slot-mobil]");if(h){const[$,R]=h.dataset.slotDriver.split("__"),O=parseInt(R||"1"),H=h.value,D=h.options[h.selectedIndex],X=H&&D?.text.split(" (")[0]||"",j=`${$}__${g.direction}__${O}`;g.slotDriverMap[j]=H;try{await v("/bookings/slot-assign",{method:"PATCH",body:{trip_date:g.date,trip_time:$,direction:g.direction,armada_index:O,driver_id:H||null,driver_name:X}}),U("Driver berhasil diperbarui")}catch(z){y(z.message||"Gagal memperbarui driver")}}if(w){const[$,R]=w.dataset.slotMobil.split("__"),O=parseInt(R||"1"),H=w.value,D=`${$}__${g.direction}__${O}`;g.slotMobilMap[D]=H}});function E(p=1,h=""){const w=document.getElementById("package-form");w&&w.reset();const $=document.getElementById("package-armada-index");$&&($.value=String(p));const R=document.getElementById("pkg-trip-date");R&&(R.value=g.date);const O=document.getElementById("pkg-trip-time");O&&h&&(O.value=h);const H=document.getElementById("pkg-bank-account-group");H&&(H.hidden=!0);const D=document.getElementById("pkg-seat-group");D&&(D.hidden=!0);const X=document.getElementById("package-form-success-banner");X&&(X.hidden=!0),M(),Oe()}function M(){const p=parseInt(document.getElementById("pkg-fare-amount")?.value||"0",10)||0,h=parseInt(document.getElementById("pkg-additional-fare")?.value||"0",10)||0,w=parseInt(document.getElementById("pkg-item-qty")?.value||"1",10)||1,$=(p+h)*w,R=document.getElementById("pkg-total-display");R&&(R.value=$>0?"Rp "+$.toLocaleString("id-ID"):"")}document.getElementById("pkg-fare-amount")?.addEventListener("input",M),document.getElementById("pkg-additional-fare")?.addEventListener("input",M),document.getElementById("pkg-item-qty")?.addEventListener("input",M),document.getElementById("pkg-payment-method")?.addEventListener("change",p=>{const h=document.getElementById("pkg-bank-account-group");h&&(h.hidden=p.target.value!=="transfer")}),document.getElementById("pkg-package-size")?.addEventListener("change",p=>{const h=document.getElementById("pkg-seat-group");h&&(h.hidden=p.target.value!=="Besar");const w=document.getElementById("pkg-seat-code");w&&p.target.value!=="Besar"&&(w.value="")}),document.getElementById("pkg-trip-date")?.addEventListener("change",()=>{Oe()}),document.getElementById("pkg-trip-time")?.addEventListener("change",()=>{Oe()}),document.getElementById("pkg-from-city")?.addEventListener("change",()=>{Oe()}),document.getElementById("pkg-to-city")?.addEventListener("change",()=>{Oe()}),document.getElementById("package-form")?.addEventListener("submit",async p=>{p.preventDefault();const h=document.getElementById("package-submit-btn");se(h,!0,"Menyimpan...");try{const w=parseInt(document.getElementById("pkg-fare-amount")?.value||"0",10)||0,$=parseInt(document.getElementById("pkg-additional-fare")?.value||"0",10)||0,R=parseInt(document.getElementById("pkg-item-qty")?.value||"1",10)||1,O=document.getElementById("pkg-payment-method")?.value||"",H={armada_index:parseInt(document.getElementById("package-armada-index")?.value||"1",10),trip_date:document.getElementById("pkg-trip-date")?.value||"",trip_time:document.getElementById("pkg-trip-time")?.value||"",from_city:document.getElementById("pkg-from-city")?.value||"",to_city:document.getElementById("pkg-to-city")?.value||"",sender_name:document.getElementById("pkg-sender-name")?.value.trim()||"",sender_phone:document.getElementById("pkg-sender-phone")?.value.trim()||"",sender_address:document.getElementById("pkg-sender-address")?.value.trim()||"",recipient_name:document.getElementById("pkg-recipient-name")?.value.trim()||"",recipient_phone:document.getElementById("pkg-recipient-phone")?.value.trim()||"",recipient_address:document.getElementById("pkg-recipient-address")?.value.trim()||"",item_name:document.getElementById("pkg-item-name")?.value.trim()||"",item_qty:R,package_size:document.getElementById("pkg-package-size")?.value||"",seat_code:document.getElementById("pkg-package-size")?.value==="Besar"&&document.getElementById("pkg-seat-code")?.value||"",fare_amount:w,additional_fare:$,payment_method:O||null,payment_status:document.getElementById("pkg-payment-status")?.value||"Belum Bayar",bank_account_code:O==="transfer"&&document.getElementById("pkg-bank-account-code")?.value||""},D=await v("/bookings/quick-package",{method:"POST",body:H}),X=document.getElementById("package-form-success-banner"),j=document.getElementById("package-form-booking-code"),z=document.getElementById("package-form-download-link");X&&(X.hidden=!1),j&&(j.textContent="Kode Booking: "+D.booking_code+(D.invoice_number&&D.invoice_number!=="-"?" | No. Surat: "+D.invoice_number:"")),z&&(z.href=D.invoice_download_url),U("Paket berhasil disimpan: "+D.booking_code),await _e()}catch(w){y(w.message||"Silakan periksa kembali data yang diinput","Gagal menyimpan paket")}finally{se(h,!1,"Menyimpan...")}}),document.getElementById("choice-passenger-btn")?.addEventListener("click",()=>{Z("booking-type-choice-modal"),Ot(g._pendingChoiceArmada||1,g._pendingChoiceTime||""),N("booking-form-modal"),requestAnimationFrame(()=>Se())}),document.getElementById("choice-package-btn")?.addEventListener("click",()=>{Z("booking-type-choice-modal"),E(g._pendingChoiceArmada||1,g._pendingChoiceTime||""),N("package-form-modal")}),t?.addEventListener("click",()=>{g._pendingChoiceArmada=1,g._pendingChoiceTime="",N("booking-type-choice-modal")}),i?.addEventListener("click",p=>{const h=p.target.closest("[data-seat-code]");if(!h||h.disabled)return;Jt();const w=h.dataset.seatCode;g.selectedSeats.includes(w)?g.selectedSeats=g.selectedSeats.filter($=>$!==w):g.selectedSeats.length<St()&&(g.selectedSeats=cn([...g.selectedSeats,w])),pe(),me()}),document.getElementById("booking-passenger-count")?.addEventListener("change",()=>{Jt(),pe(),me(),Se()}),document.getElementById("booking-additional-fare")?.addEventListener("input",Se),document.getElementById("booking-trip-date")?.addEventListener("change",()=>{qe().then(()=>{pe(),me()})}),document.getElementById("booking-trip-time")?.addEventListener("change",()=>{qe().then(()=>{pe(),me()})});let b=!1;function k(){Se(),!b&&(b=!0,setTimeout(()=>{b=!1,qe().then(()=>{pe(),me()})},50))}return["change","input"].forEach(p=>{document.getElementById("booking-from-city")?.addEventListener(p,k),document.getElementById("booking-to-city")?.addEventListener(p,k)}),d?.addEventListener("change",un),c?.addEventListener("input",p=>{const h=p.target.closest("[data-passenger-seat]");if(!h)return;const w=h.dataset.passengerSeat;g.passengerDraftMap[w]={seat_no:w,name:h.querySelector("[data-passenger-name]")?.value.trim()||"",phone:h.querySelector("[data-passenger-phone]")?.value.trim()||""}}),r?.addEventListener("submit",async p=>{p.preventDefault();const h=document.getElementById("booking-submit-btn");se(h,!0,"Menyimpan...");try{const w=xi();g.editItem?(await v(`/bookings/${g.editItem.id}`,{method:"PUT",body:w}),U("Data pemesanan berhasil diperbarui")):(await v("/bookings",{method:"POST",body:w}),U("Data pemesanan berhasil ditambahkan")),Z("booking-form-modal"),Ot(),await _e()}catch(w){y(w.message||"Silakan periksa kembali data yang diinput","Gagal menyimpan data pemesanan")}finally{se(h,!1,"Menyimpan...")}}),s?.addEventListener("click",async()=>{if(g.deleteItem){se(s,!0,"Menghapus...");try{await v(`/bookings/${g.deleteItem.id}`,{method:"DELETE"}),U("Data pemesanan berhasil dihapus"),Z("booking-delete-modal"),g.deleteItem=null,await _e()}catch(p){y(p.message||"Gagal menghapus data pemesanan")}finally{se(s,!1,"Menghapus...")}}}),Ot(),_e().catch(p=>{if(p.status===403){ia();return}y(p.message||"Gagal memuat data penumpang")})}function Ri(e){const t=document.getElementById(e);if(!t)return{};try{return JSON.parse(t.textContent||"{}")}catch{return{}}}function Pi(){const e=document.querySelector("[data-regular-booking-page]");if(!e)return;const t=Ri("regular-booking-route-matrix"),n=e.querySelector("[data-booking-origin]"),a=e.querySelector("[data-booking-destination]"),o=e.querySelector("[data-booking-schedule]"),r=e.querySelector("[data-booking-passengers]"),s=e.querySelector("[data-route-fare-input]"),i=e.querySelector("[data-additional-fare-input]"),c=e.querySelector("[data-estimated-total-input]"),d=e.querySelector("[data-route-feedback]"),l=e.querySelector("[data-route-feedback-title]"),f=e.querySelector("[data-route-feedback-text]"),E=e.querySelector("[data-booking-submit]"),M=Array.from(e.querySelectorAll("[data-booking-type]")),b=e.querySelector("[data-summary-booking-for]"),k=e.querySelector("[data-summary-route]"),p=e.querySelector("[data-summary-schedule]"),h=e.querySelector("[data-summary-passengers]"),w=e.querySelector("[data-summary-fare]"),$=e.querySelector("[data-summary-additional-fare]"),R=e.querySelector("[data-summary-total]"),O=new Map(M.map(B=>[B.value,B.dataset.label||B.value])),H=new Map(Array.from(o?.options||[]).filter(B=>B.value).map(B=>[B.value,B.textContent.trim()]));function D(B,q){if(!B||!q||B===q)return null;const K=t?.[B]?.[q];return K==null?null:Number(K)}function X(B,q,K){!d||!l||!f||(d.dataset.state=B,l.textContent=q,f.textContent=K)}function j(){e.querySelectorAll(".regular-booking-radio").forEach(B=>{const q=B.querySelector('input[type="radio"]');B.classList.toggle("is-selected",!!q?.checked)})}function z(B){return B<=0?"Belum dipilih":B===6?"6 Penumpang (Opsional tambahan)":`${B} Penumpang`}function J(){const B=n?.value||"",q=a?.value||"",K=o?.value||"",ne=Number(r?.value||0),V=M.find(Ct=>Ct.checked)?.value||"",Y=D(B,q),ae=Math.max(parseInt(i?.value||"0",10)||0,0),ce=Y!==null&&ne>0?(Y+ae)*ne:null;s&&(s.value=Y!==null?G(Y):""),c&&(c.value=ce!==null?G(ce):""),!B||!q?X("idle","Tarif akan ditampilkan otomatis","Pilih asal dan tujuan untuk melihat tarif perjalanan reguler."):B===q?X("error","Asal dan tujuan tidak boleh sama","Silakan pilih tujuan yang berbeda agar tarif dapat dihitung."):Y===null?X("error","Rute belum tersedia","Rute yang Anda pilih saat ini belum tersedia. Silakan pilih kombinasi asal dan tujuan lain."):X("ready","Rute tersedia","Tarif telah diisi otomatis berdasarkan kombinasi rute dua arah yang tersedia."),E&&(E.disabled=!!(B&&q&&(B===q||Y===null))),b&&(b.textContent=O.get(V)||"Belum dipilih"),k&&(k.textContent=B&&q?`${B} - ${q}`:"Belum dipilih"),p&&(p.textContent=H.get(K)||"Belum dipilih"),h&&(h.textContent=z(ne)),w&&(w.textContent=Y!==null?G(Y):"Belum tersedia"),$&&($.textContent=ae>0?G(ae):"Tidak ada"),R&&(R.textContent=ce!==null?G(ce):"Belum tersedia"),j()}[n,a,o,r].forEach(B=>{B?.addEventListener("change",J)}),i?.addEventListener("input",J),M.forEach(B=>{B.addEventListener("change",J)}),e.querySelector("form")?.addEventListener("reset",()=>{window.requestAnimationFrame(J)}),J()}function Di(){const e=document.querySelector("[data-regular-booking-seat-page]");if(!e)return;const t=Number(e.dataset.requiredSeatCount||0),n=Array.from(e.querySelectorAll("[data-seat-card]")),a=Array.from(e.querySelectorAll("[data-seat-input]")),o=e.querySelector("[data-seat-summary-count]"),r=e.querySelector("[data-seat-summary-list]"),s=e.querySelector("[data-seat-summary-remaining]"),i=e.querySelector("[data-seat-submit]"),c=e.querySelector("[data-seat-feedback]"),d=e.querySelector("[data-seat-feedback-title]"),l=e.querySelector("[data-seat-feedback-text]");function f(){return a.filter(k=>k.checked).map(k=>k.value)}function E(k){return k.length>0?k.join(", "):"Belum dipilih"}function M(k,p,h){!c||!d||!l||(c.dataset.state=k,d.textContent=p,l.textContent=h)}function b(){const k=f(),p=k.length,h=t>0&&p>=t;if(n.forEach(w=>{const $=w.querySelector("[data-seat-input]");if(!$)return;const R=$.disabled&&!$.checked&&w.classList.contains("is-occupied"),O=$.checked,H=R||h&&!O;R||($.disabled=H),w.classList.toggle("is-selected",O),w.classList.toggle("is-disabled",!R&&H)}),o&&(o.textContent=`${p} dari ${t}`),r&&(r.textContent=E(k)),s&&(s.textContent=String(Math.max(t-p,0))),i&&(i.disabled=p!==t),p===0){M("idle","Pilih kursi sesuai jumlah penumpang","Jumlah kursi yang dipilih harus sama dengan jumlah penumpang pada booking draft.");return}if(p<t){M("idle","Pemilihan kursi belum lengkap",`Masih perlu memilih ${t-p} kursi lagi sebelum dapat melanjutkan.`);return}if(t===6){M("ready","Semua kursi sudah terisi","Jumlah penumpang 6 orang sudah terpenuhi dan kursi tambahan 2B ikut terpakai.");return}M("ready","Kursi sudah sesuai","Jumlah kursi yang dipilih sudah sesuai dengan jumlah penumpang dan siap disimpan.")}a.forEach(k=>{k.addEventListener("change",()=>{b()})}),b()}let Ne=null,yt=!1,da="",Oi=3e3,la=0;const vt=[],L=e=>document.getElementById(e);async function Za(e){const t=e.trim();if(!t)return;const n=Date.now();if(!(t===da&&n-la<Oi)){da=t,la=n,Ce("Memproses scan…");try{const a=await v("/scan-qr",{method:"POST",body:{qr_token:t}});ji(a),Ni(a),a.already_scanned?y(a.message,"Tiket Sudah Pernah Di-Scan"):a.is_newly_eligible?U(a.message,"🎉 Eligible Diskon!"):U(a.message,"Scan Berhasil")}catch(a){qi(a.message||"Scan gagal"),y(a.message||"Scan gagal","Scan Gagal")}finally{Ce(yt?"Kamera aktif — arahkan ke QR code.":"")}}}function ji(e){L("qrscan-result-idle").hidden=!0,L("qrscan-result-card").hidden=!1;const t=e.booking||{},n=e.passenger||{},a=e.loyalty_count,o=e.loyalty_target,r=e.discount_eligible,s=Math.min(Math.round(a/o*100),100),i=e.already_scanned?"warn":e.success?"success":"error";L("qrscan-result-header").className="qrscan-result-header qrscan-result-header--"+i,L("qrscan-result-icon").innerHTML=e.already_scanned?Gi():e.success?Fi():Ya(),L("qrscan-result-title").textContent=t.booking_code||"-",L("qrscan-result-subtitle").textContent=e.message,L("qr-res-name").textContent=n.name||t.nama_pemesanan||"-",L("qr-res-code").textContent=t.booking_code||"-",L("qr-res-route").textContent=t.route_label||"-",L("qr-res-datetime").textContent=(t.trip_date||"-")+" "+(t.trip_time||""),L("qr-res-seats").textContent=n.seat_no||t.selected_seats||"-",L("qr-res-pax").textContent=(t.passenger_count||0)+" Orang",L("qr-res-loyalty-label").textContent=a+" / "+o,L("qr-res-loyalty-fill").style.width=s+"%",L("qr-res-loyalty-fill").className="qrscan-loyalty-fill"+(r?" qrscan-loyalty-fill--done":""),L("qr-res-loyalty-note").textContent=r?"✅ Eligible diskon "+(e.discount_percentage||50)+"%":"Perlu "+Math.max(o-a,0)+" perjalanan lagi untuk diskon."}function qi(e){L("qrscan-result-idle").hidden=!0,L("qrscan-result-card").hidden=!1,L("qrscan-result-header").className="qrscan-result-header qrscan-result-header--error",L("qrscan-result-icon").innerHTML=Ya(),L("qrscan-result-title").textContent="Scan Gagal",L("qrscan-result-subtitle").textContent=e,["qr-res-name","qr-res-code","qr-res-route","qr-res-datetime","qr-res-seats","qr-res-pax"].forEach(t=>{L(t).textContent="-"}),L("qr-res-loyalty-label").textContent="– / –",L("qr-res-loyalty-fill").style.width="0%",L("qr-res-loyalty-note").textContent=""}function Ni(e){const t=e.booking,n=new Date().toLocaleTimeString("id-ID",{hour:"2-digit",minute:"2-digit",second:"2-digit"}),a=e.passenger||{};vt.unshift({booking:t,passenger:a,time:n,success:e.success,already_scanned:e.already_scanned,message:e.message}),Qa()}function Qa(){const e=L("qrscan-history-list");if(vt.length===0){e.innerHTML='<p class="qrscan-history-empty">Belum ada scan dalam sesi ini.</p>';return}e.innerHTML=vt.map(t=>{const n=t.already_scanned?"warn":t.success?"ok":"err",a=t.passenger&&t.passenger.name?t.passenger.name+(t.passenger.seat_no?" ("+t.passenger.seat_no+")":""):t.booking.nama_pemesanan||"-";return`
