...
`+o):a.stack=o}catch{}}throw a}}_request(t,n){typeof t=="string"?(n=n||{},n.url=t):n=t||{},n=ge(this.defaults,n);const{transitional:a,paramsSerializer:r,headers:o}=n;a!==void 0&&tt.assertOptions(a,{silentJSONParsing:Y.transitional(Y.boolean),forcedJSONParsing:Y.transitional(Y.boolean),clarifyTimeoutError:Y.transitional(Y.boolean),legacyInterceptorReqResOrdering:Y.transitional(Y.boolean)},!1),r!=null&&(u.isFunction(r)?n.paramsSerializer={serialize:r}:tt.assertOptions(r,{encode:Y.function,serialize:Y.function},!0)),n.allowAbsoluteUrls!==void 0||(this.defaults.allowAbsoluteUrls!==void 0?n.allowAbsoluteUrls=this.defaults.allowAbsoluteUrls:n.allowAbsoluteUrls=!0),tt.assertOptions(n,{baseUrl:Y.spelling("baseURL"),withXsrfToken:Y.spelling("withXSRFToken")},!0),n.method=(n.method||this.defaults.method||"get").toLowerCase();let s=o&&u.merge(o.common,o[n.method]);o&&u.forEach(["delete","get","head","post","put","patch","common"],p=>{delete o[p]}),n.headers=X.concat(s,o);const i=[];let c=!0;this.interceptors.request.forEach(function(h){if(typeof h.runWhen=="function"&&h.runWhen(n)===!1)return;c=c&&h.synchronous;const f=n.transitional||Vt;f&&f.legacyInterceptorReqResOrdering?i.unshift(h.fulfilled,h.rejected):i.push(h.fulfilled,h.rejected)});const d=[];this.interceptors.response.forEach(function(h){d.push(h.fulfilled,h.rejected)});let l,g=0,k;if(!c){const p=[wn.bind(this),void 0];for(p.unshift(...i),p.push(...d),k=p.length,l=Promise.resolve(n);g<k;)l=l.then(p[g++],p[g++]);return l}k=i.length;let v=n;for(;g<k;){const p=i[g++],h=i[g++];try{v=p(v)}catch(f){h.call(this,f);break}}try{l=wn.call(this,v)}catch(p){return Promise.reject(p)}for(g=0,k=d.length;g<k;)l=l.then(d[g++],d[g++]);return l}getUri(t){t=ge(this.defaults,t);const n=ya(t.baseURL,t.url,t.allowAbsoluteUrls);return fa(n,t.params,t.paramsSerializer)}};u.forEach(["delete","get","head","options"],function(t){pe.prototype[t]=function(n,a){return this.request(ge(a||{},{method:t,url:n,data:(a||{}).data}))}});u.forEach(["post","put","patch"],function(t){function n(a){return function(o,s,i){return this.request(ge(i||{},{method:t,headers:a?{"Content-Type":"multipart/form-data"}:{},url:o,data:s}))}}pe.prototype[t]=n(),pe.prototype[t+"Form"]=n(!0)});let vo=class Ia{constructor(t){if(typeof t!="function")throw new TypeError("executor must be a function.");let n;this.promise=new Promise(function(o){n=o});const a=this;this.promise.then(r=>{if(!a._listeners)return;let o=a._listeners.length;for(;o-- >0;)a._listeners[o](r);a._listeners=null}),this.promise.then=r=>{let o;const s=new Promise(i=>{a.subscribe(i),o=i}).then(r);return s.cancel=function(){a.unsubscribe(o)},s},t(function(o,s,i){a.reason||(a.reason=new Ke(o,s,i),n(a.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(t){if(this.reason){t(this.reason);return}this._listeners?this._listeners.push(t):this._listeners=[t]}unsubscribe(t){if(!this._listeners)return;const n=this._listeners.indexOf(t);n!==-1&&this._listeners.splice(n,1)}toAbortSignal(){const t=new AbortController,n=a=>{t.abort(a)};return this.subscribe(n),t.signal.unsubscribe=()=>this.unsubscribe(n),t.signal}static source(){let t;return{token:new Ia(function(r){t=r}),cancel:t}}};function Eo(e){return function(n){return e.apply(null,n)}}function wo(e){return u.isObject(e)&&e.isAxiosError===!0}const Dt={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511,WebServerIsDown:521,ConnectionTimedOut:522,OriginIsUnreachable:523,TimeoutOccurred:524,SslHandshakeFailed:525,InvalidSslCertificate:526};Object.entries(Dt).forEach(([e,t])=>{Dt[t]=e});function $a(e){const t=new pe(e),n=ra(pe.prototype.request,t);return u.extend(n,pe.prototype,t,{allOwnKeys:!0}),u.extend(n,t,null,{allOwnKeys:!0}),n.create=function(r){return $a(ge(e,r))},n}const F=$a(Je);F.Axios=pe;F.CanceledError=Ke;F.CancelToken=vo;F.isCancel=ha;F.VERSION=Ba;F.toFormData=vt;F.AxiosError=I;F.Cancel=F.CanceledError;F.all=function(t){return Promise.all(t)};F.spread=Eo;F.isAxiosError=wo;F.mergeConfig=ge;F.AxiosHeaders=X;F.formToJSON=e=>ba(u.isHTMLForm(e)?new FormData(e):e);F.getAdapter=wa.getAdapter;F.HttpStatusCode=Dt;F.default=F;const{Axios:Vi,AxiosError:Gi,CanceledError:Ji,isCancel:Ki,CancelToken:Wi,VERSION:zi,all:Xi,Cancel:Zi,isAxiosError:Qi,spread:Yi,toFormData:ed,AxiosHeaders:td,HttpStatusCode:nd,formToJSON:ad,getAdapter:rd,mergeConfig:od}=F;window.axios=F;window.axios.defaults.headers.common["X-Requested-With"]="XMLHttpRequest";const Kt="transit_user",ie="transit_token",Ot="transit_pending_toast";function _e(){try{return typeof window<"u"&&typeof window.localStorage<"u"}catch{return!1}}function Sa(){try{return typeof window<"u"&&typeof window.sessionStorage<"u"}catch{return!1}}function Bo(){if(window.transitAuthUser)return window.transitAuthUser;if(!_e())return null;const e=window.localStorage.getItem(Kt);if(!e)return null;try{return JSON.parse(e)}catch{return qe(),null}}function Ca(e){if(!_e()){window.transitAuthUser=e;return}window.transitAuthUser=e,window.localStorage.setItem(Kt,JSON.stringify(e))}function Io(){if(!_e()){window.transitAuthUser=null;return}window.transitAuthUser=null,window.localStorage.removeItem(Kt)}function Wt(){return typeof window<"u"&&typeof window.transitAuthToken=="string"&&window.transitAuthToken!==""?window.transitAuthToken:_e()?window.localStorage.getItem(ie):null}function $o(e){const t=typeof e=="string"?e:"";if(!_e()){window.transitAuthToken=t||null;return}if(window.transitAuthToken=t||null,t===""){window.localStorage.removeItem(ie),document.cookie=ie+"=; path=/; max-age=0; samesite=lax";return}window.localStorage.setItem(ie,t),document.cookie=ie+"="+t+"; path=/; max-age=86400; samesite=lax"}function So(){if(!_e()){window.transitAuthToken=null,document.cookie=ie+"=; path=/; max-age=0; samesite=lax";return}window.transitAuthToken=null,window.localStorage.removeItem(ie),document.cookie=ie+"=; path=/; max-age=0; samesite=lax"}function Co(e){Sa()&&window.sessionStorage.setItem(Ot,JSON.stringify(e))}function xo(){if(!Sa())return null;const e=window.sessionStorage.getItem(Ot);if(!e)return null;window.sessionStorage.removeItem(Ot);try{return JSON.parse(e)}catch{return null}}function qe(){Io(),So()}function xa(e,t){if(!e)return t;if(typeof e.detail=="string"&&e.detail!=="")return e.detail;if(typeof e.message=="string"&&e.message!=="")return e.message;if(e.errors&&typeof e.errors=="object"){const n=Object.values(e.errors).flat()[0];if(typeof n=="string"&&n!=="")return n}return t}function In(){return document.body.dataset.apiBase||"/api"}function _a(e=""){const t=String(e).replace(/^\/+/,"");return t===""?In():`${In()}/${t}`}async function E(e,t={}){const{method:n="GET",body:a=null,headers:r={},auth:o=!0}=t,s=new Headers(r);s.set("Accept","application/json"),s.set("X-Requested-With","XMLHttpRequest");let i=a;if(a&&!(a instanceof FormData)&&!(a instanceof Blob)&&(s.set("Content-Type","application/json"),i=JSON.stringify(a)),o){const g=Wt();g&&s.set("Authorization",`Bearer ${g}`)}if(!["GET","HEAD","OPTIONS"].includes(n.toUpperCase())){const g=document.querySelector('meta[name="csrf-token"]')?.getAttribute("content");g&&s.set("X-CSRF-TOKEN",g)}const c=await fetch(_a(e),{method:n,headers:s,body:i,credentials:"same-origin"});let d=null;const l=c.headers.get("content-type")||"";if(c.status!==204&&(d=l.includes("application/json")?await c.json():await c.text()),!c.ok){c.status===401&&(qe(),(document.body.dataset.routeGuard||"none")==="protected"&&window.location.replace(document.body.dataset.loginUrl||"/login"));const g=xa(d,`Request gagal (${c.status})`),k=new Error(g);throw k.status=c.status,k.data=d,k}return d}async function zt(e,t="export.csv"){const n=new Headers({Accept:"text/csv,application/octet-stream","X-Requested-With":"XMLHttpRequest"}),a=Wt();a&&n.set("Authorization",`Bearer ${a}`);const r=await fetch(_a(e),{method:"GET",headers:n,credentials:"same-origin"});if(!r.ok){let g=null;throw(r.headers.get("content-type")||"").includes("application/json")&&(g=await r.json()),new Error(xa(g,"Gagal mengunduh file"))}const o=await r.blob(),c=(r.headers.get("content-disposition")||"").match(/filename="?([^"]+)"?/i)?.[1]||t,d=window.URL.createObjectURL(o),l=document.createElement("a");l.href=d,l.download=c,document.body.appendChild(l),l.click(),l.remove(),window.URL.revokeObjectURL(d)}function Re(e,t){const n=document.getElementById(e);n&&(n.textContent=t)}function _o(e){const t=e?.role||"";document.querySelectorAll("[data-role-scope]").forEach(n=>{const a=n.dataset.roleScope,r=a==="admin"?["Super Admin","Admin"].includes(t):a==="super"?t==="Super Admin":!0;n.hidden=!r})}function La(){return Bo()}function rt(e){if(_o(e),!e)return;const t=e.nama||"Admin",n=t.trim().split(/\s+/)[0]||"Admin",a=e.email||"admin@pekanbaru.com";Re("sidebar-user-name",t),Re("sidebar-user-email",a),Re("header-user-name",n),Re("dropdown-user-name",t),Re("dropdown-user-email",a)}function Ta(e){return typeof e.access_token=="string"&&e.access_token!==""&&$o(e.access_token),Ca(e.user),rt(e.user),e}async function Lo(e){const t=await E("/auth/login",{method:"POST",body:e,auth:!1});return Ta(t)}async function To(e){const t=await E("/auth/register",{method:"POST",body:e,auth:!1});return Ta(t)}async function $n(){const e=await E("/auth/me");return Ca(e),rt(e),e}async function Ao(){try{await E("/auth/logout",{method:"POST"})}catch(e){if(e?.status!==401)throw e}qe(),Co({type:"success",title:"Logout berhasil",message:"Sampai jumpa kembali!"}),window.location.replace(document.body.dataset.loginUrl||"/login")}function Sn(e){window.location.replace(e)}async function Ro(){const e=document.body.dataset.routeGuard||"none",t=document.body.dataset.loginUrl||"/login",n=document.body.dataset.dashboardUrl||"/dashboard",a=La();if(e==="public"){try{const r=await $n();return Sn(n),{user:r}}catch{(a||Wt())&&qe()}return{user:null}}if(e==="protected")try{return{user:await $n()}}catch{return qe(),Sn(t),{user:null}}return{user:a}}function Xt(){return Array.from(document.querySelectorAll(".modal-shell")).filter(e=>!e.hidden)}function Aa(){document.body.style.overflow=Xt().length>0?"hidden":""}function N(e){const t=document.getElementById(e);t&&(t.hidden=!1,Aa())}function V(e=null){if(e){const t=document.getElementById(e);t&&(t.hidden=!0)}else Xt().forEach(t=>{t.hidden=!0});Aa()}function Mo(){document.addEventListener("click",e=>{const t=e.target.closest("[data-modal-open]");if(t){N(t.dataset.modalOpen);return}const n=e.target.closest("[data-modal-close]");if(n){const a=n.dataset.modalClose||n.closest(".modal-shell")?.id;V(a||void 0)}}),document.addEventListener("keydown",e=>{if(e.key!=="Escape")return;const t=Xt().pop();t&&V(t.id)})}function Zt(e,t,n){const a=document.getElementById("transit-toast-root");if(!a)return;const r=document.createElement("div");r.className=`transit-toast ${n==="error"?"is-error":""} ${n==="info"?"is-info":""}`.trim(),r.innerHTML=`
    ...
    `}function st(e){const t=document.getElementById("driver-submit-btn");L.isSubmitting=e,t&&(t.disabled=e,t.textContent=e?"Menyimpan...":L.editItem?"Perbarui":"Simpan")}function ts(){const e=document.getElementById("drivers-table-body");e&&(e.innerHTML=`
        <tr>
    ...
    `).join("")}}function Tn(){const e=document.getElementById("drivers-pagination-shell"),t=document.getElementById("drivers-pagination-info"),n=document.getElementById("drivers-pagination-page"),a=document.getElementById("drivers-prev-page-btn"),r=document.getElementById("drivers-next-page-btn"),o=Math.max(1,Math.ceil(L.totalCount/Se));e&&(e.hidden=o<=1),t&&(t.textContent=Te(L.page,Se,L.totalCount,L.data.length)),n&&(n.textContent=`${L.page} / ${o}`),a&&(a.disabled=L.page===1),r&&(r.disabled=L.page>=o)}async function ke(){L.loading=!0,Ln(),Tn();try{const[e,t]=await Promise.all([E(`/drivers?page=${L.page}&limit=${Se}${L.search?`&search=${encodeURIComponent(L.search)}`:""}`),E(`/drivers/count${L.search?`?search=${encodeURIComponent(L.search)}`:""}`)]);L.data=Array.isArray(e)?e:[],L.totalCount=Number(t.count||0)}finally{L.loading=!1,Ln(),Tn()}}function An(){const e=document.getElementById("driver-form"),t=document.getElementById("driver-form-title"),n=document.getElementById("driver-form-description"),a=document.getElementById("driver-id"),r=document.getElementById("driver-nama"),o=document.getElementById("driver-lokasi");e?.reset(),a&&(a.value=""),r&&(r.value=""),o&&(o.value=""),t&&(t.textContent="Tambah Driver Baru"),n&&(n.textContent="Isi form di bawah untuk menambahkan data driver"),L.editItem=null,st(!1)}function as(e){const t=document.getElementById("driver-form-title"),n=document.getElementById("driver-form-description"),a=document.getElementById("driver-id"),r=document.getElementById("driver-nama"),o=document.getElementById("driver-lokasi");L.editItem=e,a&&(a.value=e.id),r&&(r.value=e.nama),o&&(o.value=e.lokasi),t&&(t.textContent="Edit Data Driver"),n&&(n.textContent="Isi form di bawah untuk memperbarui data driver"),st(!1)}async function rs(e){const t=await E(`/drivers/${e}`);as(t),N("driver-form-modal")}function os(e){const t=document.getElementById("driver-delete-copy");L.deleteItem=e,t&&(t.innerHTML=`Apakah Anda yakin ingin menghapus driver <strong>${m(e.nama)}</strong>? Tindakan ini tidak dapat dibatalkan.`),N("driver-delete-modal")}function ss(){const e=document.getElementById("drivers-add-btn"),t=document.getElementById("drivers-export-btn"),n=document.getElementById("drivers-search-input"),a=document.getElementById("driver-form"),r=document.getElementById("drivers-table-body"),o=document.getElementById("driver-delete-confirm-btn"),s=document.getElementById("drivers-prev-page-btn"),i=document.getElementById("drivers-next-page-btn");if(!(!e||!a||!r))return e.addEventListener("click",()=>{An(),N("driver-form-modal")}),t?.addEventListener("click",()=>{zt("/export/drivers/csv","drivers.csv").catch(()=>{y("Gagal mengunduh file")})}),n?.addEventListener("input",Le(async c=>{L.search=c.target.value.trim(),L.page=1;try{await ke()}catch{y("Gagal memuat data")}})),a.addEventListener("submit",async c=>{c.preventDefault();const d={nama:document.getElementById("driver-nama")?.value.trim()||"",lokasi:document.getElementById("driver-lokasi")?.value.trim()||""};st(!0);try{L.editItem?(await E(`/drivers/${L.editItem.id}`,{method:"PUT",body:d}),q("Data driver berhasil diperbarui")):(await E("/drivers",{method:"POST",body:d}),q("Driver berhasil ditambahkan")),V("driver-form-modal"),An(),await ke()}catch(l){y(l.message||"Silakan periksa input Anda","Gagal menyimpan data")}finally{st(!1)}}),r.addEventListener("click",async c=>{const d=c.target.closest("[data-driver-edit]"),l=c.target.closest("[data-driver-delete]");try{if(d){await rs(d.dataset.driverEdit);return}l&&os({id:l.dataset.driverDelete,nama:l.dataset.driverName})}catch{y("Gagal memuat data")}}),o?.addEventListener("click",async()=>{if(L.deleteItem)try{await E(`/drivers/${L.deleteItem.id}`,{method:"DELETE"}),q("Driver berhasil dihapus"),V("driver-delete-modal"),(L.page-1)*Se>=L.totalCount-1&&L.page>1&&(L.page-=1),L.deleteItem=null,await ke()}catch{y("Gagal menghapus data")}}),s?.addEventListener("click",async()=>{if(!(L.page<=1)){L.page-=1;try{await ke()}catch{y("Gagal memuat data")}}}),i?.addEventListener("click",async()=>{const c=Math.max(1,Math.ceil(L.totalCount/Se));if(!(L.page>=c)){L.page+=1;try{await ke()}catch{y("Gagal memuat data")}}}),ke().catch(()=>{y("Gagal memuat data")})}const w={data:[],loading:!0,totalCount:0,page:1,search:"",filterJenis:"",editItem:null,deleteItem:null,isSubmitting:!1},Ce=10;function is(){return`
        <svg viewBox="0 0 24 24" fill="none">
    ...
    `}function ut(e){return Number(document.getElementById(e)?.value||0)}function mt(){const e=ut("stock-total-snack"),t=ut("stock-total-air"),n=e*$.prices.snack+t*$.prices.air,a=document.querySelector('[data-stock-calc="nilai_total"]'),r=document.getElementById("stock-snack-price-label"),o=document.getElementById("stock-air-price-label");r&&(r.textContent=j($.prices.snack)),o&&(o.textContent=j($.prices.air)),a&&(a.textContent=j(n))}function pt(e){const t=document.getElementById("stock-submit-btn");$.isSubmitting=e,t&&(t.disabled=e,t.textContent=e?"Menyimpan...":$.editItem?"Perbarui":"Simpan")}function Cs(){const e=document.getElementById("stock-table-body"),t=document.getElementById("stock-mobile-list");e&&(e.innerHTML=`
        <tr>
    ...
    `,t&&(t.hidden=!1,t.innerHTML=`
        ...
        `))}function Fn(){const e=document.getElementById("stock-table-body"),t=document.getElementById("stock-mobile-list");if(e){if($.loading){Cs();return}if($.data.length===0){xs();return}e.innerHTML=$.data.map(n=>`
    ...
    `).join(""),t&&(t.hidden=!1,t.innerHTML=$.data.map(n=>`
        ...
        `).join(""))}}function Vn(){const e=document.getElementById("stock-pagination-shell"),t=document.getElementById("stock-pagination-info"),n=document.getElementById("stock-pagination-page"),a=document.getElementById("stock-prev-page-btn"),r=document.getElementById("stock-next-page-btn"),o=Math.max(1,Math.ceil($.totalCount/Ue));e&&(e.hidden=o<=1),t&&(t.textContent=Te($.page,Ue,$.totalCount,$.data.length)),n&&(n.textContent=`${$.page} / ${o}`),a&&(a.disabled=$.page===1),r&&(r.disabled=$.page>=o)}async function ve(){$.loading=!0,Fn(),Vn();try{const[e,t]=await Promise.all([E(`/stock?page=${$.page}&limit=${Ue}${$.search?`&search=${encodeURIComponent($.search)}`:""}`),E(`/stock/count${$.search?`?search=${encodeURIComponent($.search)}`:""}`)]);$.data=Array.isArray(e)?e:[],$.totalCount=Number(t.count||0)}finally{$.loading=!1,Fn(),Vn()}}function Gn(){const e=document.getElementById("stock-form"),t=document.getElementById("stock-form-title"),n=document.getElementById("stock-form-description");e?.reset(),$.editItem=null,document.getElementById("stock-id").value="",document.getElementById("stock-tanggal").value=We(),document.getElementById("stock-total-snack").value="0",document.getElementById("stock-total-air").value="0",document.getElementById("stock-keterangan").value="",t&&(t.textContent="Tambah Stok Baru"),n&&(n.textContent="Isi form di bawah untuk menambahkan stok snack dan air mineral"),pt(!1),mt()}function _s(e){const t=document.getElementById("stock-form-title"),n=document.getElementById("stock-form-description");$.editItem=e,document.getElementById("stock-id").value=e.id,document.getElementById("stock-tanggal").value=e.tanggal,document.getElementById("stock-total-snack").value=e.total_stock_snack,document.getElementById("stock-total-air").value=e.total_stock_air_mineral,document.getElementById("stock-keterangan").value=e.keterangan||"",t&&(t.textContent="Edit Data Stok"),n&&(n.textContent="Isi form di bawah untuk memperbarui stok snack dan air mineral"),pt(!1),mt()}async function Jn(e){const t=await E(`/stock/${e}`);_s(t),N("stock-form-modal")}function Kn(e){const t=document.getElementById("stock-delete-copy");$.deleteItem=e,t&&(t.innerHTML=`Apakah Anda yakin ingin menghapus data stok tanggal <strong>${m(e.tanggal)}</strong>? Tindakan ini tidak dapat dibatalkan.`),N("stock-delete-modal")}function Ls(){const e=document.querySelector("[data-stock-page]"),t=document.getElementById("stock-add-btn"),n=document.getElementById("stock-search-input"),a=document.getElementById("stock-form"),r=document.getElementById("stock-table-body"),o=document.getElementById("stock-mobile-list"),s=document.getElementById("stock-delete-confirm-btn"),i=document.getElementById("stock-prev-page-btn"),c=document.getElementById("stock-next-page-btn");if(!(!e||!t||!a||!r))return $.prices.snack=Number(e.dataset.stockSnackPrice||0),$.prices.air=Number(e.dataset.stockAirPrice||0),mt(),t.addEventListener("click",()=>{Gn(),N("stock-form-modal")}),n?.addEventListener("input",Le(async d=>{$.search=d.target.value.trim(),$.page=1;try{await ve()}catch{y("Gagal memuat data")}})),a.addEventListener("input",d=>{["stock-total-snack","stock-total-air"].includes(d.target.id)&&mt()}),a.addEventListener("submit",async d=>{d.preventDefault();const l={tanggal:document.getElementById("stock-tanggal")?.value||"",total_stock_snack:ut("stock-total-snack"),total_stock_air_mineral:ut("stock-total-air"),keterangan:document.getElementById("stock-keterangan")?.value.trim()||""};pt(!0);try{$.editItem?(await E(`/stock/${$.editItem.id}`,{method:"PUT",body:l}),q("Data stok berhasil diperbarui")):(await E("/stock",{method:"POST",body:l}),q("Data stok berhasil ditambahkan")),V("stock-form-modal"),Gn(),await ve()}catch(g){y(g.message||"Silakan periksa input Anda","Gagal menyimpan data")}finally{pt(!1)}}),r.addEventListener("click",async d=>{const l=d.target.closest("[data-stock-edit]"),g=d.target.closest("[data-stock-delete]");try{if(l){await Jn(l.dataset.stockEdit);return}g&&Kn({id:g.dataset.stockDelete,tanggal:g.dataset.stockDate})}catch{y("Gagal memuat data")}}),o?.addEventListener("click",async d=>{const l=d.target.closest("[data-stock-edit]"),g=d.target.closest("[data-stock-delete]");try{if(l){await Jn(l.dataset.stockEdit);return}g&&Kn({id:g.dataset.stockDelete,tanggal:g.dataset.stockDate})}catch{y("Gagal memuat data")}}),s?.addEventListener("click",async()=>{if($.deleteItem)try{await E(`/stock/${$.deleteItem.id}`,{method:"DELETE"}),q("Data stok berhasil dihapus"),V("stock-delete-modal"),($.page-1)*Ue>=$.totalCount-1&&$.page>1&&($.page-=1),$.deleteItem=null,await ve()}catch{y("Gagal menghapus data")}}),i?.addEventListener("click",async()=>{if(!($.page<=1)){$.page-=1;try{await ve()}catch{y("Gagal memuat data")}}}),c?.addEventListener("click",async()=>{const d=Math.max(1,Math.ceil($.totalCount/Ue));if(!($.page>=d)){$.page+=1;try{await ve()}catch{y("Gagal memuat data")}}}),ve().catch(()=>{y("Gagal memuat data")})}const He=10,S={currentUser:null,data:[],loading:!0,totalCount:0,page:1,search:"",editItem:null,deleteItem:null,defaultRole:"User"};function Ts(e){return["Super Admin","Admin"].includes(e)}function As(e){return e==="Super Admin"}function Rs(){return`
        <svg viewBox="0 0 24 24" fill="none">
            <path d="M20 21C20 17.6863 16.4183 15 12 15C7.58172 15 4 17.6863 4 21" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path>
            <circle cx="12" cy="8" r="4" stroke="currentColor" stroke-width="1.8"></circle>
        </svg>
    ...
    `)}function Wn(){const e=document.getElementById("admin-users-table-body");if(e){if(S.loading){qs();return}if(S.data.length===0){Da();return}e.innerHTML=S.data.map(t=>`
    ...
    `).join("")}}function qt(){const e=document.getElementById("admin-users-pagination-shell"),t=document.getElementById("admin-users-pagination-info"),n=document.getElementById("admin-users-pagination-page"),a=document.getElementById("admin-users-prev-page-btn"),r=document.getElementById("admin-users-next-page-btn"),o=Math.max(1,Math.ceil(S.totalCount/He));e&&(e.hidden=o<=1),t&&(t.textContent=Te(S.page,He,S.totalCount,S.data.length)),n&&(n.textContent=`${S.page} / ${o}`),a&&(a.disabled=S.page===1),r&&(r.disabled=S.page>=o)}async function Ee(){S.loading=!0,Wn(),qt();try{const e=S.search?`?search=${encodeURIComponent(S.search)}`:"",t=`?page=${S.page}&limit=${He}${S.search?`&search=${encodeURIComponent(S.search)}`:""}`,[n,a]=await Promise.all([E(`/admin-users${t}`),E(`/admin-users/count${e}`)]);S.data=Array.isArray(n)?n:[],S.totalCount=Number(a.count||0)}finally{S.loading=!1,Wn(),qt()}}function Oa(e="User"){const t=document.getElementById("admin-user-role");if(!t)return;const n=Os(),a=n.includes(e)?e:n[0];t.innerHTML=n.map(r=>`
        <option value="${m(r)}" ${r===a?"selected":""}>${m(r)}</option>
    `).join("")}function ja(e){const t=document.getElementById("admin-user-password"),n=document.getElementById("admin-user-password-note");t&&(t.required=!e,t.placeholder=e?"Kosongkan jika tidak ingin mengubah password":"Masukkan password",t.value=""),n&&(n.textContent=e?"Kosongkan password jika tidak ingin mengubah password akun ini.":"Password minimal 6 karakter dan akan disimpan dalam bentuk terenkripsi.")}function Tt(e="User"){const t=document.getElementById("admin-user-form"),n=document.getElementById("admin-user-form-title"),a=document.getElementById("admin-user-form-description"),r=document.getElementById("admin-user-id");t?.reset(),r&&(r.value=""),Oa(e),ja(!1),n&&(n.textContent=e==="Admin"?"Tambah Admin Baru":"Tambah User Baru"),a&&(a.textContent=e==="Admin"?"Lengkapi data akun untuk menambahkan admin baru":"Lengkapi data akun untuk menambahkan user baru"),S.defaultRole=e,S.editItem=null,gt(!1)}function Ns(e){S.editItem=e,document.getElementById("admin-user-id").value=e.id,document.getElementById("admin-user-nama").value=e.nama,document.getElementById("admin-user-username").value=e.username,document.getElementById("admin-user-email").value=e.email,Oa(e.role),ja(!0),document.getElementById("admin-user-form-title").textContent="Edit Akun",document.getElementById("admin-user-form-description").textContent="Perbarui informasi akun admin atau user di bawah ini",gt(!1)}function Us(e){const t=document.getElementById("admin-user-detail-list");t&&(t.innerHTML=`
    ...
    `)}async function Hs(e){Us(await E(`/admin-users/${e}`)),N("admin-user-show-modal")}async function Fs(e){Ns(await E(`/admin-users/${e}`)),N("admin-user-form-modal")}function Vs(e){S.deleteItem=e,document.getElementById("admin-user-delete-copy").innerHTML=`Apakah Anda yakin ingin menghapus akun <strong>${m(e.nama)}</strong>? Tindakan ini tidak dapat dibatalkan.`,N("admin-user-delete-modal")}function zn(){const e=document.getElementById("admin-users-access-note"),t=document.getElementById("admin-users-search-input"),n=document.querySelector(".admin-users-page-actions");e&&(e.hidden=!1,e.textContent="Halaman ini hanya dapat diakses oleh Admin atau Super Admin."),t&&(t.disabled=!0),n&&(n.hidden=!0),S.loading=!1,S.data=[],S.totalCount=0,Da("Anda tidak memiliki akses untuk mengelola data admin dan user."),qt()}function Gs({user:e}={}){const t=document.getElementById("admin-users-add-admin-btn"),n=document.getElementById("admin-users-add-user-btn"),a=document.getElementById("admin-users-search-input"),r=document.getElementById("admin-user-form"),o=document.getElementById("admin-users-table-body"),s=document.getElementById("admin-user-delete-confirm-btn"),i=document.getElementById("admin-users-prev-page-btn"),c=document.getElementById("admin-users-next-page-btn");if(!(!t||!n||!r||!o)){if(S.currentUser=e||window.transitAuthUser||null,!Ts(S.currentUser?.role)){zn();return}return t.addEventListener("click",()=>{Tt("Admin"),N("admin-user-form-modal")}),n.addEventListener("click",()=>{Tt("User"),N("admin-user-form-modal")}),a?.addEventListener("input",Le(async d=>{S.search=d.target.value.trim(),S.page=1;try{await Ee()}catch(l){y(l.message||"Gagal memuat data akun")}})),r.addEventListener("submit",async d=>{d.preventDefault();const l={nama:document.getElementById("admin-user-nama")?.value.trim()||"",username:document.getElementById("admin-user-username")?.value.trim()||"",email:document.getElementById("admin-user-email")?.value.trim()||"",password:document.getElementById("admin-user-password")?.value||"",role:document.getElementById("admin-user-role")?.value||"User"};gt(!0);try{S.editItem?(await E(`/admin-users/${S.editItem.id}`,{method:"PUT",body:l}),q("Akun berhasil diperbarui")):(await E("/admin-users",{method:"POST",body:l}),q(l.role==="Admin"?"Admin berhasil ditambahkan":"User berhasil ditambahkan")),V("admin-user-form-modal"),Tt(S.defaultRole),await Ee()}catch(g){y(g.message||"Silakan periksa kembali data yang diinput","Gagal menyimpan akun")}finally{gt(!1)}}),o.addEventListener("click",async d=>{const l=d.target.closest("[data-admin-user-show]"),g=d.target.closest("[data-admin-user-edit]"),k=d.target.closest("[data-admin-user-delete]");try{if(l){await Hs(l.dataset.adminUserShow);return}if(g){await Fs(g.dataset.adminUserEdit);return}k&&Vs({id:k.dataset.adminUserDelete,nama:k.dataset.adminUserName})}catch(v){y(v.message||"Gagal memuat detail akun")}}),s?.addEventListener("click",async()=>{if(S.deleteItem)try{await E(`/admin-users/${S.deleteItem.id}`,{method:"DELETE"}),q("Akun berhasil dihapus"),V("admin-user-delete-modal"),(S.page-1)*He>=S.totalCount-1&&S.page>1&&(S.page-=1),S.deleteItem=null,await Ee()}catch(d){y(d.message||"Gagal menghapus akun")}}),i?.addEventListener("click",async()=>{if(!(S.page<=1)){S.page-=1;try{await Ee()}catch(d){y(d.message||"Gagal memuat data akun")}}}),c?.addEventListener("click",async()=>{const d=Math.max(1,Math.ceil(S.totalCount/He));if(!(S.page>=d)){S.page+=1;try{await Ee()}catch(l){y(l.message||"Gagal memuat data akun")}}}),Ee().catch(d=>{if(d.status===403){zn();return}y(d.message||"Gagal memuat data akun")})}}const Xn=[{value:"05:00",label:"Subuh",time:"05.00 WIB"},{value:"08:00",label:"Pagi",time:"08.00 WIB"},{value:"10:00",label:"Pagi",time:"10.00 WIB"},{value:"14:00",label:"Siang",time:"14.00 WIB"},{value:"16:00",label:"Sore",time:"16.00 WIB"},{value:"19:00",label:"Malam",time:"19.00 WIB"}],qa=[[{code:"1A",label:"1A"},{code:"SOPIR",label:"SOPIR",isDriver:!0}],[{code:"2A",label:"2A"},{code:"3A",label:"3A"}],[{code:"4A",label:"4A"},{code:"5A",label:"5A"}]],Zn=qa.flat().filter(e=>!e.isDriver).length,b={currentUser:null,date:We(),direction:"to_pkb",bookings:[],loading:!1,drivers:[],mobils:[],formOptions:null,selectedSeats:[],passengerDraftMap:{},editItem:null,deleteItem:null,slotDriverMap:{},slotMobilMap:{},occupiedSeatsForForm:[],slotExtraArmadas:{},currentFormArmadaIndex:1};function At(e){const t=document.getElementById(e);if(!t)return null;try{return JSON.parse(t.textContent||"{}")}catch{return null}}function Js(e){return["Super Admin","Admin"].includes(e)}function Ks(e){const t=e?"#dc2626":"#166534",n=e?"#991b1b":"#14532d";return`
        ...
        </div>`}function ei(e){const t={};return e.forEach(n=>{(Array.isArray(n.selected_seats)?n.selected_seats:[]).forEach(r=>{t[r]||(t[r]=n)})}),t}function ti(e,t,n,a){const r=ei(n),o=n.reduce((f,x)=>f+(Number(x.passenger_count)||0),0),s=o>=Zn,i=`${e.value}__${b.direction}__${t}`;if(!b.slotDriverMap[i]){const f=n.find(x=>x.driver_id);f&&(b.slotDriverMap[i]=f.driver_id)}const c=b.slotDriverMap[i]||"",d=b.slotMobilMap[i]||"",l=s?"stock-value-badge-red":"stock-value-badge-yellow",g=b.drivers.map(f=>{const x=f.lokasi?`${f.nama} (${f.lokasi})`:f.nama;return`<option value="${m(f.id)}" ${c===f.id?"selected":""}>${m(x)}</option>`}).join(""),k=b.mobils.map(f=>{const x=`${f.kode_mobil} — ${f.jenis_mobil}`;return`<option value="${m(f.id)}" ${d===f.id?"selected":""}>${m(x)}</option>`}).join(""),v=[...new Set(n.map(f=>(f.service_type||"").trim()).filter(Boolean))],p=a>1?`<span class="bpg-armada-badge">${Zs()} Armada ${t}</span>`:"",h=s?`<button class="bpg-add-armada-btn" type="button"
        ...
        </article>`}function ni(e,t){const n={};t.forEach(c=>{const d=c.armada_index||1;n[d]||(n[d]=[]),n[d].push(c)});const a=`${e.value}__${b.direction}`,r=t.length>0?Math.max(...Object.keys(n).map(Number)):1,o=b.slotExtraArmadas[a]||1,s=Math.max(r,o),i=[];for(let c=1;c<=s;c++)i.push(ti(e,c,n[c]||[],s));return`<div class="bpg-slot-group" data-slot-group="${m(e.value)}">${i.join("")}</div>`}function ai(){const e=document.getElementById("bpg-slots-shell");e&&(e.innerHTML=`
            <div class="admin-users-loading-inline" style="padding:40px 0;">
                <span class="admin-users-loading-inline-spinner" aria-hidden="true"></span>
                <span>Memuat data penumpang...</span>
            </div>`)}function Na(){const e=document.getElementById("bpg-slots-shell");if(!e)return;const t={};Xn.forEach(a=>{t[a.value]=[]}),b.bookings.forEach(a=>{const o=(a.trip_time||"").trim().substring(0,5);t[o]&&t[o].push(a)});const n=Xn.map(a=>ni(a,t[a.value]||[]));e.innerHTML=`<div class="bpg-slots-grid">${n.join("")}</div>`}async function Pe(){b.loading=!0,ai();try{const e=new URLSearchParams({date:b.date,direction:b.direction,limit:200,page:1}),[t,n]=await Promise.all([E(`/bookings?${e}`),E(`/bookings/armada-extras?date=${b.date}`).catch(()=>({}))]);b.bookings=Array.isArray(t)?t:[],n&&typeof n=="object"&&Object.entries(n).forEach(([a,r])=>{const o=`${a}__${b.direction}`;b.slotExtraArmadas[o]=Math.max(b.slotExtraArmadas[o]||1,Number(r)||1)})}catch(e){b.bookings=[],e.status!==403&&y(e.message||"Gagal memuat data penumpang")}finally{b.loading=!1,Na()}}function ri(e){document.getElementById("bpg-detail-title").textContent=e.nama_pemesanan||"-",document.getElementById("bpg-detail-subtitle").textContent=`${e.booking_code||"-"} · ${e.booking_status||"-"}`,document.getElementById("bpg-detail-full-link").href=`/dashboard/bookings/${e.id}`,document.getElementById("bpg-detail-ticket-link").href=`/dashboard/bookings/${e.id}/ticket`;const t=document.getElementById("bpg-detail-body");t.innerHTML=`
        ...
        </div>`,N("bpg-detail-modal")}function oi(){return(b.formOptions?.seat_options||[]).map(e=>e.code)}function an(e){const t=new Map(oi().map((n,a)=>[n,a]));return Array.from(new Set((e||[]).map(n=>String(n).trim()).filter(n=>t.has(n)))).sort((n,a)=>(t.get(n)??999)-(t.get(a)??999))}function Bt(){return Number(document.getElementById("booking-passenger-count")?.value||0)}function si(){const e=Bt();return(b.formOptions?.seat_options||[]).filter(t=>!t.is_optional||e>=6).map(t=>t.code)}function ii(){return b.formOptions?.payment_status_options||[]}function di(e){return e==="transfer"?["Belum Bayar","Menunggu Pembayaran","Menunggu Verifikasi","Dibayar"]:e==="qris"?["Belum Bayar","Menunggu Pembayaran","Dibayar"]:e==="cash"?["Belum Bayar","Dibayar Tunai"]:["Belum Bayar"]}function li(e){return e==="transfer"?"Menunggu Pembayaran":e==="qris"?"Dibayar":e==="cash"?"Dibayar Tunai":"Belum Bayar"}function ci(e){return e==="transfer"?"Menunggu Verifikasi Pembayaran":e==="qris"||e==="cash"?"Diproses":"Draft"}function ui(e,t){if(!e||!t||e===t)return null;const a=(b.formOptions?.route_matrix||{})?.[e]?.[t];return a==null?null:Number(a)}function Oe(){const e=document.getElementById("booking-from-city")?.value||"",t=document.getElementById("booking-to-city")?.value||"",n=Bt(),a=ui(e,t),r=a!==null?a*n:null,o=document.getElementById("booking-price-per-seat"),s=document.getElementById("booking-total-amount");o&&(o.value=a!==null?j(a):""),s&&(s.value=r!==null?j(r):"")}function rn(){const e=document.getElementById("booking-payment-method")?.value||"",t=document.getElementById("booking-payment-status"),n=document.getElementById("booking-booking-status"),a=document.getElementById("booking-bank-account-group"),r=document.getElementById("booking-bank-account-code"),o=di(e),s=t?.value||"";a&&(a.hidden=e!=="transfer"),r&&e!=="transfer"&&(r.value=""),t&&(t.innerHTML=ii().filter(i=>o.includes(i.value)).map(i=>`<option value="${m(i.value)}">${m(i.label)}</option>`).join(""),t.value=o.includes(s)?s:li(e)),n&&(n.value=ci(e))}function mi(){const e=document.getElementById("booking-selected-seats-inputs");e&&(e.innerHTML=b.selectedSeats.map(t=>`<input type="hidden" name="selected_seats[]" value="${m(t)}">`).join(""))}function pi(){const e=document.getElementById("booking-selected-seat-count"),t=document.getElementById("booking-selected-seat-label");e&&(e.textContent=String(b.selectedSeats.length)),t&&(t.textContent=b.selectedSeats.length>0?b.selectedSeats.join(", "):"Belum dipilih")}function Nt(){document.querySelectorAll("[data-passenger-seat]").forEach(e=>{const t=e.dataset.passengerSeat;t&&(b.passengerDraftMap[t]={seat_no:t,name:e.querySelector("[data-passenger-name]")?.value.trim()||"",phone:e.querySelector("[data-passenger-phone]")?.value.trim()||""})})}function oe(e=null){const t=document.getElementById("booking-passenger-editor");if(t){if(e&&(b.passengerDraftMap=Object.fromEntries(e.map(n=>[n.seat_no,n]))),b.selectedSeats.length===0){t.innerHTML='<div class="dashboard-empty-state dashboard-empty-state--block bookings-passenger-empty">Pilih kursi terlebih dahulu untuk menampilkan form data penumpang.</div>';return}t.innerHTML=`
        ...
        </div>`}).join("")}function Ci(){if(!window.Html5Qrcode){y("Library scanner tidak tersedia. Coba muat ulang halaman.","Error");return}C("qrscan-placeholder").hidden=!0,C("qrscan-frame").hidden=!1,C("qrscan-btn-start").hidden=!0,C("qrscan-btn-stop").hidden=!1,ft=!0,Ie("Menginisialisasi kamera…"),je=new window.Html5Qrcode("qrscan-reader"),je.start({facingMode:"environment"},{fps:10,qrbox:{width:240,height:240}},e=>{let t=e.trim();try{const n=JSON.parse(e);n&&(n.qr_token||n.passenger_qr_token)&&(t=n.qr_token||n.passenger_qr_token)}catch{}Ua(t)},()=>{}).then(()=>{Ie("Kamera aktif — arahkan ke QR code.")}).catch(e=>{ft=!1,C("qrscan-placeholder").hidden=!1,C("qrscan-frame").hidden=!0,C("qrscan-btn-start").hidden=!1,C("qrscan-btn-stop").hidden=!0,Ie("Gagal mengakses kamera. Pastikan izin kamera sudah diberikan."),y(String(e),"Kamera Error")})}function xi(){je&&je.stop().catch(()=>{}).finally(()=>{je=null}),ft=!1,C("qrscan-placeholder").hidden=!1,C("qrscan-frame").hidden=!0,C("qrscan-btn-start").hidden=!1,C("qrscan-btn-stop").hidden=!0,Ie("Kamera dihentikan.")}function Ie(e){C("qrscan-status-text").textContent=e}function _i(){return`<svg viewBox="0 0 24 24" fill="none">
    ...
    </svg>`}function Ti(){C("qrscan-btn-start").addEventListener("click",Ci),C("qrscan-btn-stop").addEventListener("click",xi),C("qrscan-clear-history").addEventListener("click",()=>{bt.length=0,Ha()}),C("qrscan-manual-form").addEventListener("submit",e=>{e.preventDefault();const t=C("qrscan-manual-input").value.trim();t&&(Ua(t),C("qrscan-manual-input").value="")})}const _={data:[],loading:!0,totalCount:0,page:1,search:"",chartLimit:10,editItem:null,deleteItem:null,isSubmitting:!1};let Ze=null;const fe=15,Ai=()=>`<svg viewBox="0 0 24 24" fill="none">
    ...
    <path d="M9 7V5.5C9 4.67157 9.67157 4 10.5 4H13.5C14.3284 4 15 4.67157 15 5.5V7" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/>
        ...
        <tr class="plkt-row">
            <td class="plkt-index-cell">${(_.page-1)*fe+n+1}</td>
            <td>
        ...
        </tr>`).join("")}}function aa(){const e=document.getElementById("plkt-pagination-shell"),t=document.getElementById("plkt-pagination-info"),n=document.getElementById("plkt-pagination-page"),a=document.getElementById("plkt-prev-page-btn"),r=document.getElementById("plkt-next-page-btn"),o=Math.max(1,Math.ceil(_.totalCount/fe));e&&(e.hidden=o<=1),t&&(t.textContent=Te(_.page,fe,_.totalCount,_.data.length)),n&&(n.textContent=`${_.page} / ${o}`),a&&(a.disabled=_.page===1),r&&(r.disabled=_.page>=o)}async function we(){_.loading=!0,na(),aa();try{const[e,t]=await Promise.all([E(`/passengers-lkt?page=${_.page}&limit=${fe}${_.search?`&search=${encodeURIComponent(_.search)}`:""}`),E(`/passengers-lkt/count${_.search?`?search=${encodeURIComponent(_.search)}`:""}`)]);_.data=Array.isArray(e)?e:[],_.totalCount=Number(t?.count||0)}catch(e){y(e.message||"Gagal memuat data","Error"),_.data=[],_.totalCount=0}finally{_.loading=!1,na(),aa()}}function Ut(e){const t=document.getElementById("plkt-edit-submit-btn");_.isSubmitting=e,t&&(t.disabled=e,t.textContent=e?"Menyimpan...":"Simpan")}async function Di(e){try{const t=await E(`/passengers-lkt/${e}`);_.editItem=t;const n=document.getElementById("plkt-edit-name"),a=document.getElementById("plkt-edit-phone"),r=document.getElementById("plkt-edit-id");r&&(r.value=t.id),n&&(n.value=t.name||""),a&&(a.value=t.phone||""),Ut(!1),N("plkt-edit-modal")}catch{y("Gagal memuat data penumpang")}}function Oi(e,t){_.deleteItem={id:e,name:t};const n=document.getElementById("plkt-delete-copy");n&&(n.innerHTML=`Apakah Anda yakin ingin menghapus penumpang <strong>${m(t)}</strong>? Tindakan ini tidak dapat dibatalkan.`),N("plkt-delete-modal")}async function Qe(){const e=document.getElementById("plkt-loyalty-chart"),t=document.getElementById("plkt-chart-empty");if(e)try{const n=await E(`/passengers-lkt/loyalty-chart?limit=${_.chartLimit}`);if(!Array.isArray(n)||n.length===0){e.hidden=!0,t&&(t.hidden=!1);return}e.hidden=!1,t&&(t.hidden=!0);const a=n.map(i=>i.passenger_name+(i.phone&&i.phone!=="-"?` (${i.phone})`:"")),r=n.map(i=>i.booking_count),o=Math.max(...r,1),s=r.map(i=>{const c=i/o;return`rgba(${Math.round(26+c*30)}, ${Math.round(35+c*80)}, ${Math.round(126+c*50)}, 0.85)`});Ze&&(Ze.destroy(),Ze=null),Ze=new window.Chart(e,{type:"bar",data:{labels:a,datasets:[{label:"Jumlah Pemesanan",data:r,backgroundColor:s,borderRadius:6,borderSkipped:!1}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1},tooltip:{callbacks:{title:i=>i[0].label,label:i=>` ${i.raw} kali pemesanan`}}},scales:{x:{ticks:{maxRotation:35,font:{size:11},color:"#374151"},grid:{display:!1}},y:{beginAtZero:!0,ticks:{stepSize:1,color:"#374151",font:{size:11}},grid:{color:"rgba(0,0,0,0.06)"}}}}})}catch{t&&(t.hidden=!1)}}function ji(){if(_.data.length===0){y("Tidak ada data untuk diekspor.");return}const e=["No","Nama Penumpang","No HP","Dari","Tujuan","Tanggal Berangkat","Jam","Tarif","Kali Memesan"],t=_.data.map((s,i)=>[(_.page-1)*fe+i+1,s.passenger_name||"-",s.phone||"-",s.from_city||"-",s.to_city||"-",s.trip_date||"-",s.trip_time||"-",s.tarif||"-",s.booking_count]),n=[e,...t].map(s=>s.map(i=>`"${String(i).replace(/"/g,'""')}"`).join(",")).join(`
`),a=new Blob(["\uFEFF"+n],{type:"text/csv;charset=utf-8;"}),r=URL.createObjectURL(a),o=document.createElement("a");o.href=r,o.download="data-penumpang-lkt.csv",o.click(),URL.revokeObjectURL(r)}function qi(){const e=document.getElementById("plkt-search-input"),t=document.getElementById("plkt-prev-page-btn"),n=document.getElementById("plkt-next-page-btn"),a=document.getElementById("plkt-export-btn"),r=document.getElementById("plkt-chart-limit"),o=document.getElementById("plkt-table-body"),s=document.getElementById("plkt-edit-form"),i=document.getElementById("plkt-delete-confirm-btn");e?.addEventListener("input",Le(async c=>{_.search=c.target.value.trim(),_.page=1,await we().catch(()=>y("Gagal memuat data"))},400)),t?.addEventListener("click",async()=>{_.page<=1||(_.page-=1,await we().catch(()=>y("Gagal memuat data")))}),n?.addEventListener("click",async()=>{const c=Math.max(1,Math.ceil(_.totalCount/fe));_.page>=c||(_.page+=1,await we().catch(()=>y("Gagal memuat data")))}),a?.addEventListener("click",ji),r?.addEventListener("change",async c=>{_.chartLimit=parseInt(c.target.value,10)||10,await Qe().catch(()=>{})}),o?.addEventListener("click",async c=>{const d=c.target.closest("[data-plkt-edit]"),l=c.target.closest("[data-plkt-delete]");d&&await Di(d.dataset.plktEdit),l&&Oi(l.dataset.plktDelete,l.dataset.plktName)}),s?.addEventListener("submit",async c=>{c.preventDefault();const d=document.getElementById("plkt-edit-id")?.value,l=document.getElementById("plkt-edit-name")?.value.trim(),g=document.getElementById("plkt-edit-phone")?.value.trim();if(!l){y("Nama penumpang tidak boleh kosong");return}Ut(!0);try{await E(`/passengers-lkt/${d}`,{method:"PUT",body:{name:l,phone:g}}),q("Data penumpang berhasil diperbarui"),V("plkt-edit-modal"),await Promise.all([we(),Qe()])}catch(k){y(k.message||"Gagal menyimpan data")}finally{Ut(!1)}}),i?.addEventListener("click",async()=>{if(_.deleteItem)try{await E(`/passengers-lkt/${_.deleteItem.id}`,{method:"DELETE"}),q("Data penumpang berhasil dihapus"),V("plkt-delete-modal"),_.deleteItem=null,(_.page-1)*fe>=_.totalCount-1&&_.page>1&&(_.page-=1),await Promise.all([we(),Qe()])}catch(c){y(c.message||"Gagal menghapus data")}}),we().catch(()=>y("Gagal memuat data")),Qe().catch(()=>{})}const Ni={"admin-users/index":Gs,"auth/login":jo,"bookings/index":yi,"dashboard/index":Xo,"drivers/index":ss,"mobil/index":hs,"keberangkatan/index":Is,"regular-bookings/index":Ei,"regular-bookings/seats":wi,"stock/index":Ls,"qr-scan/index":Ti,"passengers-lkt/index":qi};document.addEventListener("DOMContentLoaded",async()=>{Mo(),Oo(),rt(La());const e=xo();e&&(e.type==="success"?q(e.message,e.title):e.type==="info"?Po(e.message,e.title):y(e.message,e.title));try{const{user:t}=await Ro();t&&rt(t);const n=document.body.dataset.pageScript,a=Ni[n];typeof a=="function"&&await a({user:t})}catch(t){console.error(t),y(t.message||"Terjadi kesalahan saat memuat halaman")}});
