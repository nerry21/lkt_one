...
`+o):a.stack=o}catch{}}throw a}}_request(t,n){typeof t=="string"?(n=n||{},n.url=t):n=t||{},n=de(this.defaults,n);const{transitional:a,paramsSerializer:r,headers:o}=n;a!==void 0&&Ve.assertOptions(a,{silentJSONParsing:X.transitional(X.boolean),forcedJSONParsing:X.transitional(X.boolean),clarifyTimeoutError:X.transitional(X.boolean),legacyInterceptorReqResOrdering:X.transitional(X.boolean)},!1),r!=null&&(c.isFunction(r)?n.paramsSerializer={serialize:r}:Ve.assertOptions(r,{encode:X.function,serialize:X.function},!0)),n.allowAbsoluteUrls!==void 0||(this.defaults.allowAbsoluteUrls!==void 0?n.allowAbsoluteUrls=this.defaults.allowAbsoluteUrls:n.allowAbsoluteUrls=!0),Ve.assertOptions(n,{baseUrl:X.spelling("baseURL"),withXsrfToken:X.spelling("withXSRFToken")},!0),n.method=(n.method||this.defaults.method||"get").toLowerCase();let s=o&&c.merge(o.common,o[n.method]);o&&c.forEach(["delete","get","head","post","put","patch","common"],p=>{delete o[p]}),n.headers=W.concat(s,o);const i=[];let m=!0;this.interceptors.request.forEach(function(b){if(typeof b.runWhen=="function"&&b.runWhen(n)===!1)return;m=m&&b.synchronous;const h=n.transitional||Rt;h&&h.legacyInterceptorReqResOrdering?i.unshift(b.fulfilled,b.rejected):i.push(b.fulfilled,b.rejected)});const d=[];this.interceptors.response.forEach(function(b){d.push(b.fulfilled,b.rejected)});let l,u=0,f;if(!m){const p=[un.bind(this),void 0];for(p.unshift(...i),p.push(...d),f=p.length,l=Promise.resolve(n);u<f;)l=l.then(p[u++],p[u++]);return l}f=i.length;let y=n;for(;u<f;){const p=i[u++],b=i[u++];try{y=p(y)}catch(h){b.call(this,h);break}}try{l=un.call(this,y)}catch(p){return Promise.reject(p)}for(u=0,f=d.length;u<f;)l=l.then(d[u++],d[u++]);return l}getUri(t){t=de(this.defaults,t);const n=na(t.baseURL,t.url,t.allowAbsoluteUrls);return Qn(n,t.params,t.paramsSerializer)}};c.forEach(["delete","get","head","options"],function(t){ie.prototype[t]=function(n,a){return this.request(de(a||{},{method:t,url:n,data:(a||{}).data}))}});c.forEach(["post","put","patch"],function(t){function n(a){return function(o,s,i){return this.request(de(i||{},{method:t,headers:a?{"Content-Type":"multipart/form-data"}:{},url:o,data:s}))}}ie.prototype[t]=n(),ie.prototype[t+"Form"]=n(!0)});let Qr=class ia{constructor(t){if(typeof t!="function")throw new TypeError("executor must be a function.");let n;this.promise=new Promise(function(o){n=o});const a=this;this.promise.then(r=>{if(!a._listeners)return;let o=a._listeners.length;for(;o-- >0;)a._listeners[o](r);a._listeners=null}),this.promise.then=r=>{let o;const s=new Promise(i=>{a.subscribe(i),o=i}).then(r);return s.cancel=function(){a.unsubscribe(o)},s},t(function(o,s,i){a.reason||(a.reason=new Pe(o,s,i),n(a.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(t){if(this.reason){t(this.reason);return}this._listeners?this._listeners.push(t):this._listeners=[t]}unsubscribe(t){if(!this._listeners)return;const n=this._listeners.indexOf(t);n!==-1&&this._listeners.splice(n,1)}toAbortSignal(){const t=new AbortController,n=a=>{t.abort(a)};return this.subscribe(n),t.signal.unsubscribe=()=>this.unsubscribe(n),t.signal}static source(){let t;return{token:new ia(function(r){t=r}),cancel:t}}};function Yr(e){return function(n){return e.apply(null,n)}}function eo(e){return c.isObject(e)&&e.isAxiosError===!0}const $t={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511,WebServerIsDown:521,ConnectionTimedOut:522,OriginIsUnreachable:523,TimeoutOccurred:524,SslHandshakeFailed:525,InvalidSslCertificate:526};Object.entries($t).forEach(([e,t])=>{$t[t]=e});function da(e){const t=new ie(e),n=qn(ie.prototype.request,t);return c.extend(n,ie.prototype,t,{allOwnKeys:!0}),c.extend(n,t,null,{allOwnKeys:!0}),n.create=function(r){return da(de(e,r))},n}const N=da(Me);N.Axios=ie;N.CanceledError=Pe;N.CancelToken=Qr;N.isCancel=ea;N.VERSION=sa;N.toFormData=lt;N.AxiosError=B;N.Cancel=N.CanceledError;N.all=function(t){return Promise.all(t)};N.spread=Yr;N.isAxiosError=eo;N.mergeConfig=de;N.AxiosHeaders=W;N.formToJSON=e=>Yn(c.isHTMLForm(e)?new FormData(e):e);N.getAdapter=oa.getAdapter;N.HttpStatusCode=$t;N.default=N;const{Axios:oi,AxiosError:si,CanceledError:ii,isCancel:di,CancelToken:li,VERSION:ci,all:ui,Cancel:mi,isAxiosError:pi,spread:gi,toFormData:fi,AxiosHeaders:bi,HttpStatusCode:hi,formToJSON:ki,getAdapter:yi,mergeConfig:vi}=N;window.axios=N;window.axios.defaults.headers.common["X-Requested-With"]="XMLHttpRequest";const Ot="transit_user",We="transit_token",Ct="transit_pending_toast";function Ee(){try{return typeof window<"u"&&typeof window.localStorage<"u"}catch{return!1}}function la(){try{return typeof window<"u"&&typeof window.sessionStorage<"u"}catch{return!1}}function to(){if(window.transitAuthUser)return window.transitAuthUser;if(!Ee())return null;const e=window.localStorage.getItem(Ot);if(!e)return null;try{return JSON.parse(e)}catch{return Ce(),null}}function ca(e){if(!Ee()){window.transitAuthUser=e;return}window.transitAuthUser=e,window.localStorage.setItem(Ot,JSON.stringify(e))}function no(){if(!Ee()){window.transitAuthUser=null;return}window.transitAuthUser=null,window.localStorage.removeItem(Ot)}function Dt(){return typeof window<"u"&&typeof window.transitAuthToken=="string"&&window.transitAuthToken!==""?window.transitAuthToken:Ee()?window.localStorage.getItem(We):null}function ao(e){const t=typeof e=="string"?e:"";if(!Ee()){window.transitAuthToken=t||null;return}if(window.transitAuthToken=t||null,t===""){window.localStorage.removeItem(We);return}window.localStorage.setItem(We,t)}function ro(){if(!Ee()){window.transitAuthToken=null;return}window.transitAuthToken=null,window.localStorage.removeItem(We)}function oo(e){la()&&window.sessionStorage.setItem(Ct,JSON.stringify(e))}function so(){if(!la())return null;const e=window.sessionStorage.getItem(Ct);if(!e)return null;window.sessionStorage.removeItem(Ct);try{return JSON.parse(e)}catch{return null}}function Ce(){no(),ro()}function ua(e,t){if(!e)return t;if(typeof e.detail=="string"&&e.detail!=="")return e.detail;if(typeof e.message=="string"&&e.message!=="")return e.message;if(e.errors&&typeof e.errors=="object"){const n=Object.values(e.errors).flat()[0];if(typeof n=="string"&&n!=="")return n}return t}function pn(){return document.body.dataset.apiBase||"/api"}function ma(e=""){const t=String(e).replace(/^\/+/,"");return t===""?pn():`${pn()}/${t}`}async function I(e,t={}){const{method:n="GET",body:a=null,headers:r={},auth:o=!0}=t,s=new Headers(r);s.set("Accept","application/json"),s.set("X-Requested-With","XMLHttpRequest");let i=a;if(a&&!(a instanceof FormData)&&!(a instanceof Blob)&&(s.set("Content-Type","application/json"),i=JSON.stringify(a)),o){const u=Dt();u&&s.set("Authorization",`Bearer ${u}`)}if(!["GET","HEAD","OPTIONS"].includes(n.toUpperCase())){const u=document.querySelector('meta[name="csrf-token"]')?.getAttribute("content");u&&s.set("X-CSRF-TOKEN",u)}const m=await fetch(ma(e),{method:n,headers:s,body:i,credentials:"same-origin"});let d=null;const l=m.headers.get("content-type")||"";if(m.status!==204&&(d=l.includes("application/json")?await m.json():await m.text()),!m.ok){m.status===401&&(Ce(),(document.body.dataset.routeGuard||"none")==="protected"&&window.location.replace(document.body.dataset.loginUrl||"/login"));const u=ua(d,`Request gagal (${m.status})`),f=new Error(u);throw f.status=m.status,f.data=d,f}return d}async function jt(e,t="export.csv"){const n=new Headers({Accept:"text/csv,application/octet-stream","X-Requested-With":"XMLHttpRequest"}),a=Dt();a&&n.set("Authorization",`Bearer ${a}`);const r=await fetch(ma(e),{method:"GET",headers:n,credentials:"same-origin"});if(!r.ok){let u=null;throw(r.headers.get("content-type")||"").includes("application/json")&&(u=await r.json()),new Error(ua(u,"Gagal mengunduh file"))}const o=await r.blob(),m=(r.headers.get("content-disposition")||"").match(/filename="?([^"]+)"?/i)?.[1]||t,d=window.URL.createObjectURL(o),l=document.createElement("a");l.href=d,l.download=m,document.body.appendChild(l),l.click(),l.remove(),window.URL.revokeObjectURL(d)}function Be(e,t){const n=document.getElementById(e);n&&(n.textContent=t)}function io(e){const t=e?.role||"";document.querySelectorAll("[data-role-scope]").forEach(n=>{const a=n.dataset.roleScope,r=a==="admin"?["Super Admin","Admin"].includes(t):a==="super"?t==="Super Admin":!0;n.hidden=!r})}function pa(){return to()}function Ke(e){if(io(e),!e)return;const t=e.nama||"Admin",n=t.trim().split(/\s+/)[0]||"Admin",a=e.email||"admin@pekanbaru.com";Be("sidebar-user-name",t),Be("sidebar-user-email",a),Be("header-user-name",n),Be("dropdown-user-name",t),Be("dropdown-user-email",a)}function ga(e){return typeof e.access_token=="string"&&e.access_token!==""&&ao(e.access_token),ca(e.user),Ke(e.user),e}async function lo(e){const t=await I("/auth/login",{method:"POST",body:e,auth:!1});return ga(t)}async function co(e){const t=await I("/auth/register",{method:"POST",body:e,auth:!1});return ga(t)}async function gn(){const e=await I("/auth/me");return ca(e),Ke(e),e}async function uo(){try{await I("/auth/logout",{method:"POST"})}catch(e){if(e?.status!==401)throw e}Ce(),oo({type:"success",title:"Logout berhasil",message:"Sampai jumpa kembali!"}),window.location.replace(document.body.dataset.loginUrl||"/login")}function fn(e){window.location.replace(e)}async function mo(){const e=document.body.dataset.routeGuard||"none",t=document.body.dataset.loginUrl||"/login",n=document.body.dataset.dashboardUrl||"/dashboard",a=pa();if(e==="public"){try{const r=await gn();return fn(n),{user:r}}catch{(a||Dt())&&Ce()}return{user:null}}if(e==="protected")try{return{user:await gn()}}catch{return Ce(),fn(t),{user:null}}return{user:a}}function Nt(){return Array.from(document.querySelectorAll(".modal-shell")).filter(e=>!e.hidden)}function fa(){document.body.style.overflow=Nt().length>0?"hidden":""}function D(e){const t=document.getElementById(e);t&&(t.hidden=!1,fa())}function G(e=null){if(e){const t=document.getElementById(e);t&&(t.hidden=!0)}else Nt().forEach(t=>{t.hidden=!0});fa()}function po(){document.addEventListener("click",e=>{const t=e.target.closest("[data-modal-open]");if(t){D(t.dataset.modalOpen);return}const n=e.target.closest("[data-modal-close]");if(n){const a=n.dataset.modalClose||n.closest(".modal-shell")?.id;G(a||void 0)}}),document.addEventListener("keydown",e=>{if(e.key!=="Escape")return;const t=Nt().pop();t&&G(t.id)})}function Ut(e,t,n){const a=document.getElementById("transit-toast-root");if(!a)return;const r=document.createElement("div");r.className=`transit-toast ${n==="error"?"is-error":""} ${n==="info"?"is-info":""}`.trim(),r.innerHTML=`
    ...
    `)}function yn(){const e=document.getElementById("drivers-table-body");if(e){if(C.loading){Mo();return}if(C.data.length===0){Po();return}e.innerHTML=C.data.map((t,n)=>`
        <tr class="drivers-row" data-testid="driver-row-${t.id}">
            <td class="drivers-index-cell">${(C.page-1)*ke+n+1}</td>
            <td>
    ...
    `).join("")}}function vn(){const e=document.getElementById("drivers-pagination-shell"),t=document.getElementById("drivers-pagination-info"),n=document.getElementById("drivers-pagination-page"),a=document.getElementById("drivers-prev-page-btn"),r=document.getElementById("drivers-next-page-btn"),o=Math.max(1,Math.ceil(C.totalCount/ke));e&&(e.hidden=o<=1),t&&(t.textContent=De(C.page,ke,C.totalCount,C.data.length)),n&&(n.textContent=`${C.page} / ${o}`),a&&(a.disabled=C.page===1),r&&(r.disabled=C.page>=o)}async function ue(){C.loading=!0,yn(),vn();try{const[e,t]=await Promise.all([I(`/drivers?page=${C.page}&limit=${ke}${C.search?`&search=${encodeURIComponent(C.search)}`:""}`),I(`/drivers/count${C.search?`?search=${encodeURIComponent(C.search)}`:""}`)]);C.data=Array.isArray(e)?e:[],C.totalCount=Number(t.count||0)}finally{C.loading=!1,yn(),vn()}}function En(){const e=document.getElementById("driver-form"),t=document.getElementById("driver-form-title"),n=document.getElementById("driver-form-description"),a=document.getElementById("driver-id"),r=document.getElementById("driver-nama"),o=document.getElementById("driver-lokasi");e?.reset(),a&&(a.value=""),r&&(r.value=""),o&&(o.value=""),t&&(t.textContent="Tambah Driver Baru"),n&&(n.textContent="Isi form di bawah untuk menambahkan data driver"),C.editItem=null,Xe(!1)}function Oo(e){const t=document.getElementById("driver-form-title"),n=document.getElementById("driver-form-description"),a=document.getElementById("driver-id"),r=document.getElementById("driver-nama"),o=document.getElementById("driver-lokasi");C.editItem=e,a&&(a.value=e.id),r&&(r.value=e.nama),o&&(o.value=e.lokasi),t&&(t.textContent="Edit Data Driver"),n&&(n.textContent="Isi form di bawah untuk memperbarui data driver"),Xe(!1)}async function Do(e){const t=await I(`/drivers/${e}`);Oo(t),D("driver-form-modal")}function jo(e){const t=document.getElementById("driver-delete-copy");C.deleteItem=e,t&&(t.innerHTML=`Apakah Anda yakin ingin menghapus driver <strong>${g(e.nama)}</strong>? Tindakan ini tidak dapat dibatalkan.`),D("driver-delete-modal")}function No(){const e=document.getElementById("drivers-add-btn"),t=document.getElementById("drivers-export-btn"),n=document.getElementById("drivers-search-input"),a=document.getElementById("driver-form"),r=document.getElementById("drivers-table-body"),o=document.getElementById("driver-delete-confirm-btn"),s=document.getElementById("drivers-prev-page-btn"),i=document.getElementById("drivers-next-page-btn");if(!(!e||!a||!r))return e.addEventListener("click",()=>{En(),D("driver-form-modal")}),t?.addEventListener("click",()=>{jt("/export/drivers/csv","drivers.csv").catch(()=>{v("Gagal mengunduh file")})}),n?.addEventListener("input",Oe(async m=>{C.search=m.target.value.trim(),C.page=1;try{await ue()}catch{v("Gagal memuat data")}})),a.addEventListener("submit",async m=>{m.preventDefault();const d={nama:document.getElementById("driver-nama")?.value.trim()||"",lokasi:document.getElementById("driver-lokasi")?.value.trim()||""};Xe(!0);try{C.editItem?(await I(`/drivers/${C.editItem.id}`,{method:"PUT",body:d}),O("Data driver berhasil diperbarui")):(await I("/drivers",{method:"POST",body:d}),O("Driver berhasil ditambahkan")),G("driver-form-modal"),En(),await ue()}catch(l){v(l.message||"Silakan periksa input Anda","Gagal menyimpan data")}finally{Xe(!1)}}),r.addEventListener("click",async m=>{const d=m.target.closest("[data-driver-edit]"),l=m.target.closest("[data-driver-delete]");try{if(d){await Do(d.dataset.driverEdit);return}l&&jo({id:l.dataset.driverDelete,nama:l.dataset.driverName})}catch{v("Gagal memuat data")}}),o?.addEventListener("click",async()=>{if(C.deleteItem)try{await I(`/drivers/${C.deleteItem.id}`,{method:"DELETE"}),O("Driver berhasil dihapus"),G("driver-delete-modal"),(C.page-1)*ke>=C.totalCount-1&&C.page>1&&(C.page-=1),C.deleteItem=null,await ue()}catch{v("Gagal menghapus data")}}),s?.addEventListener("click",async()=>{if(!(C.page<=1)){C.page-=1;try{await ue()}catch{v("Gagal memuat data")}}}),i?.addEventListener("click",async()=>{const m=Math.max(1,Math.ceil(C.totalCount/ke));if(!(C.page>=m)){C.page+=1;try{await ue()}catch{v("Gagal memuat data")}}}),ue().catch(()=>{v("Gagal memuat data")})}const E={data:[],loading:!0,totalCount:0,page:1,search:"",filterJenis:"",editItem:null,deleteItem:null,isSubmitting:!1},ye=10;function Uo(){return`
        <svg viewBox="0 0 24 24" fill="none">
    ...
    `)}function wn(){const e=document.getElementById("mobil-table-body");if(e){if(E.loading){Go();return}if(E.data.length===0){Jo();return}e.innerHTML=E.data.map((t,n)=>`
        <tr class="mobil-row" data-testid="mobil-row-${t.id}">
            <td class="mobil-index-cell">${(E.page-1)*ye+n+1}</td>
            <td>
    ...
    `,t&&(t.hidden=!1,t.innerHTML=`
        ...
        `))}function _n(){const e=document.getElementById("keberangkatan-table-body"),t=document.getElementById("keberangkatan-mobile-list");if(e){if(w.loading){ts();return}if(w.data.length===0){ns();return}e.innerHTML=w.data.map(n=>`
    ...
    `).join(""),t&&(t.hidden=!1,t.innerHTML=S.data.map(n=>`
        ...
        `).join(""))}}function Rn(){const e=document.getElementById("stock-pagination-shell"),t=document.getElementById("stock-pagination-info"),n=document.getElementById("stock-pagination-page"),a=document.getElementById("stock-prev-page-btn"),r=document.getElementById("stock-next-page-btn"),o=Math.max(1,Math.ceil(S.totalCount/xe));e&&(e.hidden=o<=1),t&&(t.textContent=De(S.page,xe,S.totalCount,S.data.length)),n&&(n.textContent=`${S.page} / ${o}`),a&&(a.disabled=S.page===1),r&&(r.disabled=S.page>=o)}async function pe(){S.loading=!0,An(),Rn();try{const[e,t]=await Promise.all([I(`/stock?page=${S.page}&limit=${xe}${S.search?`&search=${encodeURIComponent(S.search)}`:""}`),I(`/stock/count${S.search?`?search=${encodeURIComponent(S.search)}`:""}`)]);S.data=Array.isArray(e)?e:[],S.totalCount=Number(t.count||0)}finally{S.loading=!1,An(),Rn()}}function Mn(){const e=document.getElementById("stock-form"),t=document.getElementById("stock-form-title"),n=document.getElementById("stock-form-description");e?.reset(),S.editItem=null,document.getElementById("stock-id").value="",document.getElementById("stock-tanggal").value=je(),document.getElementById("stock-total-snack").value="0",document.getElementById("stock-total-air").value="0",document.getElementById("stock-keterangan").value="",t&&(t.textContent="Tambah Stok Baru"),n&&(n.textContent="Isi form di bawah untuk menambahkan stok snack dan air mineral"),at(!1),nt()}function ds(e){const t=document.getElementById("stock-form-title"),n=document.getElementById("stock-form-description");S.editItem=e,document.getElementById("stock-id").value=e.id,document.getElementById("stock-tanggal").value=e.tanggal,document.getElementById("stock-total-snack").value=e.total_stock_snack,document.getElementById("stock-total-air").value=e.total_stock_air_mineral,document.getElementById("stock-keterangan").value=e.keterangan||"",t&&(t.textContent="Edit Data Stok"),n&&(n.textContent="Isi form di bawah untuk memperbarui stok snack dan air mineral"),at(!1),nt()}async function Pn(e){const t=await I(`/stock/${e}`);ds(t),D("stock-form-modal")}function On(e){const t=document.getElementById("stock-delete-copy");S.deleteItem=e,t&&(t.innerHTML=`Apakah Anda yakin ingin menghapus data stok tanggal <strong>${g(e.tanggal)}</strong>? Tindakan ini tidak dapat dibatalkan.`),D("stock-delete-modal")}function ls(){const e=document.querySelector("[data-stock-page]"),t=document.getElementById("stock-add-btn"),n=document.getElementById("stock-search-input"),a=document.getElementById("stock-form"),r=document.getElementById("stock-table-body"),o=document.getElementById("stock-mobile-list"),s=document.getElementById("stock-delete-confirm-btn"),i=document.getElementById("stock-prev-page-btn"),m=document.getElementById("stock-next-page-btn");if(!(!e||!t||!a||!r))return S.prices.snack=Number(e.dataset.stockSnackPrice||0),S.prices.air=Number(e.dataset.stockAirPrice||0),nt(),t.addEventListener("click",()=>{Mn(),D("stock-form-modal")}),n?.addEventListener("input",Oe(async d=>{S.search=d.target.value.trim(),S.page=1;try{await pe()}catch{v("Gagal memuat data")}})),a.addEventListener("input",d=>{["stock-total-snack","stock-total-air"].includes(d.target.id)&&nt()}),a.addEventListener("submit",async d=>{d.preventDefault();const l={tanggal:document.getElementById("stock-tanggal")?.value||"",total_stock_snack:tt("stock-total-snack"),total_stock_air_mineral:tt("stock-total-air"),keterangan:document.getElementById("stock-keterangan")?.value.trim()||""};at(!0);try{S.editItem?(await I(`/stock/${S.editItem.id}`,{method:"PUT",body:l}),O("Data stok berhasil diperbarui")):(await I("/stock",{method:"POST",body:l}),O("Data stok berhasil ditambahkan")),G("stock-form-modal"),Mn(),await pe()}catch(u){v(u.message||"Silakan periksa input Anda","Gagal menyimpan data")}finally{at(!1)}}),r.addEventListener("click",async d=>{const l=d.target.closest("[data-stock-edit]"),u=d.target.closest("[data-stock-delete]");try{if(l){await Pn(l.dataset.stockEdit);return}u&&On({id:u.dataset.stockDelete,tanggal:u.dataset.stockDate})}catch{v("Gagal memuat data")}}),o?.addEventListener("click",async d=>{const l=d.target.closest("[data-stock-edit]"),u=d.target.closest("[data-stock-delete]");try{if(l){await Pn(l.dataset.stockEdit);return}u&&On({id:u.dataset.stockDelete,tanggal:u.dataset.stockDate})}catch{v("Gagal memuat data")}}),s?.addEventListener("click",async()=>{if(S.deleteItem)try{await I(`/stock/${S.deleteItem.id}`,{method:"DELETE"}),O("Data stok berhasil dihapus"),G("stock-delete-modal"),(S.page-1)*xe>=S.totalCount-1&&S.page>1&&(S.page-=1),S.deleteItem=null,await pe()}catch{v("Gagal menghapus data")}}),i?.addEventListener("click",async()=>{if(!(S.page<=1)){S.page-=1;try{await pe()}catch{v("Gagal memuat data")}}}),m?.addEventListener("click",async()=>{const d=Math.max(1,Math.ceil(S.totalCount/xe));if(!(S.page>=d)){S.page+=1;try{await pe()}catch{v("Gagal memuat data")}}}),pe().catch(()=>{v("Gagal memuat data")})}const Te=10,$={currentUser:null,data:[],loading:!0,totalCount:0,page:1,search:"",editItem:null,deleteItem:null,defaultRole:"User"};function cs(e){return["Super Admin","Admin"].includes(e)}function us(e){return e==="Super Admin"}function ms(){return`
        <svg viewBox="0 0 24 24" fill="none">
            <path d="M20 21C20 17.6863 16.4183 15 12 15C7.58172 15 4 17.6863 4 21" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"></path>
            <circle cx="12" cy="8" r="4" stroke="currentColor" stroke-width="1.8"></circle>
        </svg>
    ...
    `).join("")}}function xt(){const e=document.getElementById("admin-users-pagination-shell"),t=document.getElementById("admin-users-pagination-info"),n=document.getElementById("admin-users-pagination-page"),a=document.getElementById("admin-users-prev-page-btn"),r=document.getElementById("admin-users-next-page-btn"),o=Math.max(1,Math.ceil($.totalCount/Te));e&&(e.hidden=o<=1),t&&(t.textContent=De($.page,Te,$.totalCount,$.data.length)),n&&(n.textContent=`${$.page} / ${o}`),a&&(a.disabled=$.page===1),r&&(r.disabled=$.page>=o)}async function ge(){$.loading=!0,Dn(),xt();try{const e=$.search?`?search=${encodeURIComponent($.search)}`:"",t=`?page=${$.page}&limit=${Te}${$.search?`&search=${encodeURIComponent($.search)}`:""}`,[n,a]=await Promise.all([I(`/admin-users${t}`),I(`/admin-users/count${e}`)]);$.data=Array.isArray(n)?n:[],$.totalCount=Number(a.count||0)}finally{$.loading=!1,Dn(),xt()}}function va(e="User"){const t=document.getElementById("admin-user-role");if(!t)return;const n=bs(),a=n.includes(e)?e:n[0];t.innerHTML=n.map(r=>`
    ...
    `)}async function Es(e){vs(await I(`/admin-users/${e}`)),D("admin-user-show-modal")}async function ws(e){ys(await I(`/admin-users/${e}`)),D("admin-user-form-modal")}function Bs(e){$.deleteItem=e,document.getElementById("admin-user-delete-copy").innerHTML=`Apakah Anda yakin ingin menghapus akun <strong>${g(e.nama)}</strong>? Tindakan ini tidak dapat dibatalkan.`,D("admin-user-delete-modal")}function jn(){const e=document.getElementById("admin-users-access-note"),t=document.getElementById("admin-users-search-input"),n=document.querySelector(".admin-users-page-actions");e&&(e.hidden=!1,e.textContent="Halaman ini hanya dapat diakses oleh Admin atau Super Admin."),t&&(t.disabled=!0),n&&(n.hidden=!0),$.loading=!1,$.data=[],$.totalCount=0,ya("Anda tidak memiliki akses untuk mengelola data admin dan user."),xt()}function Is({user:e}={}){const t=document.getElementById("admin-users-add-admin-btn"),n=document.getElementById("admin-users-add-user-btn"),a=document.getElementById("admin-users-search-input"),r=document.getElementById("admin-user-form"),o=document.getElementById("admin-users-table-body"),s=document.getElementById("admin-user-delete-confirm-btn"),i=document.getElementById("admin-users-prev-page-btn"),m=document.getElementById("admin-users-next-page-btn");if(!(!t||!n||!r||!o)){if($.currentUser=e||window.transitAuthUser||null,!cs($.currentUser?.role)){jn();return}return t.addEventListener("click",()=>{vt("Admin"),D("admin-user-form-modal")}),n.addEventListener("click",()=>{vt("User"),D("admin-user-form-modal")}),a?.addEventListener("input",Oe(async d=>{$.search=d.target.value.trim(),$.page=1;try{await ge()}catch(l){v(l.message||"Gagal memuat data akun")}})),r.addEventListener("submit",async d=>{d.preventDefault();const l={nama:document.getElementById("admin-user-nama")?.value.trim()||"",username:document.getElementById("admin-user-username")?.value.trim()||"",email:document.getElementById("admin-user-email")?.value.trim()||"",password:document.getElementById("admin-user-password")?.value||"",role:document.getElementById("admin-user-role")?.value||"User"};rt(!0);try{$.editItem?(await I(`/admin-users/${$.editItem.id}`,{method:"PUT",body:l}),O("Akun berhasil diperbarui")):(await I("/admin-users",{method:"POST",body:l}),O(l.role==="Admin"?"Admin berhasil ditambahkan":"User berhasil ditambahkan")),G("admin-user-form-modal"),vt($.defaultRole),await ge()}catch(u){v(u.message||"Silakan periksa kembali data yang diinput","Gagal menyimpan akun")}finally{rt(!1)}}),o.addEventListener("click",async d=>{const l=d.target.closest("[data-admin-user-show]"),u=d.target.closest("[data-admin-user-edit]"),f=d.target.closest("[data-admin-user-delete]");try{if(l){await Es(l.dataset.adminUserShow);return}if(u){await ws(u.dataset.adminUserEdit);return}f&&Bs({id:f.dataset.adminUserDelete,nama:f.dataset.adminUserName})}catch(y){v(y.message||"Gagal memuat detail akun")}}),s?.addEventListener("click",async()=>{if($.deleteItem)try{await I(`/admin-users/${$.deleteItem.id}`,{method:"DELETE"}),O("Akun berhasil dihapus"),G("admin-user-delete-modal"),($.page-1)*Te>=$.totalCount-1&&$.page>1&&($.page-=1),$.deleteItem=null,await ge()}catch(d){v(d.message||"Gagal menghapus akun")}}),i?.addEventListener("click",async()=>{if(!($.page<=1)){$.page-=1;try{await ge()}catch(d){v(d.message||"Gagal memuat data akun")}}}),m?.addEventListener("click",async()=>{const d=Math.max(1,Math.ceil($.totalCount/Te));if(!($.page>=d)){$.page+=1;try{await ge()}catch(l){v(l.message||"Gagal memuat data akun")}}}),ge().catch(d=>{if(d.status===403){jn();return}v(d.message||"Gagal memuat data akun")})}}const Nn=[{value:"05:00",label:"Subuh",time:"05.00 WIB"},{value:"08:00",label:"Pagi",time:"08.00 WIB"},{value:"10:00",label:"Pagi",time:"10.00 WIB"},{value:"14:00",label:"Siang",time:"14.00 WIB"},{value:"16:00",label:"Sore",time:"16.00 WIB"},{value:"19:00",label:"Malam",time:"19.00 WIB"}],wa=[[{code:"1A",label:"1A"},{code:"SOPIR",label:"SOPIR",isDriver:!0}],[{code:"2A",label:"2A"},{code:"3A",label:"3A"}],[{code:"4A",label:"4A"},{code:"5A",label:"5A"}]],Ss=wa.flat().filter(e=>!e.isDriver).length,k={currentUser:null,date:je(),direction:"to_pkb",bookings:[],loading:!1,drivers:[],mobils:[],formOptions:null,selectedSeats:[],passengerDraftMap:{},editItem:null,deleteItem:null,slotDriverMap:{},slotMobilMap:{},occupiedSeatsForForm:[]};function Et(e){const t=document.getElementById(e);if(!t)return null;try{return JSON.parse(t.textContent||"{}")}catch{return null}}function $s(e){return["Super Admin","Admin"].includes(e)}function Cs(e){const t=e?"#dc2626":"#166534",n=e?"#991b1b":"#14532d";return`
        ...
        </div>`}}async function ot(){const e=document.getElementById("booking-trip-date")?.value||"",t=document.getElementById("booking-trip-time")?.value||"",n=k.editItem?.id||"";if(!e||!t){k.occupiedSeatsForForm=[];return}try{const a=new URLSearchParams({trip_date:e,trip_time:t});n&&a.set("exclude_id",n);const r=await I(`/bookings/occupied-seats?${a}`);k.occupiedSeatsForForm=Array.isArray(r?.occupied_seats)?r.occupied_seats:[]}catch{k.occupiedSeatsForForm=[]}}function be(){const e=document.querySelectorAll("[data-seat-code]"),t=mt(),n=Ns();k.selectedSeats=Jt(k.selectedSeats.filter(a=>n.includes(a)&&!k.occupiedSeatsForForm.includes(a))),e.forEach(a=>{const r=a.dataset.seatCode,o=n.includes(r),s=k.occupiedSeatsForForm.includes(r),i=k.selectedSeats.includes(r),m=k.selectedSeats.length>=t&&!i;a.hidden=!o,a.classList.toggle("is-selected",i),a.classList.toggle("is-occupied",s),a.classList.toggle("is-disabled",!s&&m),a.disabled=!o||s||!i&&m,s?a.title="Kursi sudah dipesan":a.title=""}),Gs(),Js()}function wt(){document.getElementById("booking-form")?.reset(),k.editItem=null,k.selectedSeats=[],k.passengerDraftMap={};const t=k.date||je();document.getElementById("booking-id").value="",document.getElementById("booking-form-title").textContent="Tambah Pemesanan",document.getElementById("booking-form-description").textContent="Lengkapi data pemesanan reguler dari dashboard admin.",document.getElementById("booking-trip-date").value=t,document.getElementById("booking-passenger-count").value="1",document.getElementById("booking-payment-method").value="",document.getElementById("booking-booking-status").value="Draft",Wt(),$e(),se(document.getElementById("booking-submit-btn"),!1,"Menyimpan..."),ot().then(()=>{be(),fe()})}function Ws(e){k.editItem=e,k.selectedSeats=Jt(e.selected_seats||[]),k.passengerDraftMap=Object.fromEntries((e.passengers||[]).map(t=>[t.seat_no,t])),document.getElementById("booking-id").value=e.id,document.getElementById("booking-booking-for").value=e.booking_for,document.getElementById("booking-category").value=e.category,document.getElementById("booking-from-city").value=e.from_city,document.getElementById("booking-to-city").value=e.to_city,document.getElementById("booking-trip-date").value=e.trip_date_value,document.getElementById("booking-trip-time").value=e.trip_time_value,document.getElementById("booking-passenger-count").value=String(e.passenger_count),document.getElementById("booking-driver-name").value=e.driver_name==="Menunggu Penetapan Driver"?"":e.driver_name||"",document.getElementById("booking-pickup-location").value=e.pickup_location,document.getElementById("booking-dropoff-location").value=e.dropoff_location,document.getElementById("booking-payment-method").value=e.payment_method_value||"",Wt(),document.getElementById("booking-payment-status").value=e.payment_status,document.getElementById("booking-booking-status").value=e.booking_status,document.getElementById("booking-bank-account-code").value=e.bank_account_code||"",document.getElementById("booking-notes").value=e.notes||"",document.getElementById("booking-form-title").textContent="Edit Pemesanan",document.getElementById("booking-form-description").textContent="Perbarui data pemesanan reguler yang dipilih.",$e(),se(document.getElementById("booking-submit-btn"),!1,"Menyimpan..."),ot().then(()=>{be(),fe(e.passengers||[])})}function Ks(){return Tt(),{booking_for:document.getElementById("booking-booking-for")?.value||"",category:document.getElementById("booking-category")?.value||"Reguler",from_city:document.getElementById("booking-from-city")?.value||"",to_city:document.getElementById("booking-to-city")?.value||"",trip_date:document.getElementById("booking-trip-date")?.value||"",trip_time:document.getElementById("booking-trip-time")?.value||"",passenger_count:Number(document.getElementById("booking-passenger-count")?.value||0),driver_name:document.getElementById("booking-driver-name")?.value.trim()||"",pickup_location:document.getElementById("booking-pickup-location")?.value.trim()||"",dropoff_location:document.getElementById("booking-dropoff-location")?.value.trim()||"",selected_seats:k.selectedSeats,passengers:k.selectedSeats.map(e=>({seat_no:e,name:k.passengerDraftMap?.[e]?.name||"",phone:k.passengerDraftMap?.[e]?.phone||""})),payment_method:document.getElementById("booking-payment-method")?.value||"",payment_status:document.getElementById("booking-payment-status")?.value||"Belum Bayar",booking_status:document.getElementById("booking-booking-status")?.value||"Draft",bank_account_code:document.getElementById("booking-bank-account-code")?.value||"",notes:document.getElementById("booking-notes")?.value.trim()||""}}async function zs(e){Ws(await I(`/bookings/${e}`)),D("booking-form-modal")}function Xs(e){k.deleteItem=e,document.getElementById("booking-delete-copy").innerHTML=`Apakah Anda yakin ingin menghapus data pemesanan <strong>${g(e.nama)}</strong>? Tindakan ini tidak dapat dibatalkan.`,D("booking-delete-modal")}function Un(){const e=document.getElementById("bookings-access-note"),t=document.getElementById("bpg-route-tabs"),n=document.getElementById("bpg-slots-shell");e&&(e.hidden=!1),t&&(t.hidden=!0),n&&(n.hidden=!0)}function Zs({user:e}={}){const t=document.getElementById("bookings-add-btn"),n=document.getElementById("bookings-date-picker"),a=document.getElementById("bpg-route-tabs"),r=document.getElementById("bpg-slots-shell"),o=document.getElementById("booking-form"),s=document.getElementById("booking-delete-confirm-btn"),i=document.getElementById("booking-seat-grid"),m=document.getElementById("booking-passenger-editor"),d=document.getElementById("booking-payment-method");if(k.formOptions=Et("bookings-form-options"),k.drivers=Et("bookings-drivers-data")||[],k.mobils=Et("bookings-mobils-data")||[],k.currentUser=e||window.transitAuthUser||null,k.date=je(),!$s(k.currentUser?.role)){Un();return}a&&(a.hidden=!1),r&&(r.hidden=!1);const l=document.getElementById("bookings-access-note");l&&(l.hidden=!0),n&&(n.value=k.date,n.addEventListener("change",async()=>{k.date=n.value,k.slotDriverMap={},k.slotMobilMap={},await Se()})),a?.addEventListener("click",async f=>{const y=f.target.closest("[data-direction]");if(!y)return;const p=y.dataset.direction;p!==k.direction&&(k.direction=p,k.slotDriverMap={},k.slotMobilMap={},document.querySelectorAll(".bpg-route-tab").forEach(b=>{b.classList.toggle("is-active",b.dataset.direction===p)}),await Se())});function u(f=null){r?.querySelectorAll("[data-depart-dropdown]").forEach(y=>{String(y.dataset.departDropdown)!==String(f)&&(y.querySelector(".bpg-depart-menu")?.removeAttribute("hidden"),y.querySelector(".bpg-depart-menu")?.setAttribute("hidden",""))})}return document.addEventListener("click",f=>{f.target.closest("[data-depart-dropdown]")||u()}),r?.addEventListener("click",async f=>{const y=f.target.closest("[data-depart-toggle]"),p=f.target.closest("[data-booking-departure]"),b=f.target.closest("[data-booking-lihat]"),h=f.target.closest("[data-booking-edit]"),T=f.target.closest("[data-booking-delete]");try{if(y){const A=y.dataset.departToggle,R=r.querySelector(`[data-depart-dropdown="${CSS.escape(A)}"]`)?.querySelector(".bpg-depart-menu");if(!R)return;const P=R.hasAttribute("hidden");u(A),R.toggleAttribute("hidden",!P);return}if(p){const A=p.dataset.bookingDeparture,x=p.dataset.departureStatus,R=k.bookings.find(U=>String(U.id)===String(A));if(!R)return;const P=R.departure_status===x?"":x;R.departure_status=P;const q=r.querySelector(`[data-depart-dropdown="${CSS.escape(A)}"]`);if(q){const U=q.querySelector(".bpg-depart-trigger"),Z=departureStatusMeta(P);U.className=`bpg-depart-trigger ${Z.cls}`,U.childNodes.forEach(K=>{K.nodeType===3&&(K.textContent=Z.label)}),q.querySelectorAll("[data-booking-departure]").forEach(K=>{K.classList.toggle("is-active",K.dataset.departureStatus===P)}),q.querySelector(".bpg-depart-menu")?.setAttribute("hidden","")}await I(`/bookings/${A}/departure-status`,{method:"PATCH",body:{departure_status:P}});return}if(b){const A=b.dataset.bookingLihat,x=k.bookings.find(R=>String(R.id)===String(A));x&&Ds(x);return}if(h){await zs(h.dataset.bookingEdit);return}T&&Xs({id:T.dataset.bookingDelete,nama:T.dataset.bookingName})}catch(A){v(A.message||"Gagal memuat data pemesanan")}}),r?.addEventListener("change",async f=>{const y=f.target.closest("[data-slot-driver]"),p=f.target.closest("[data-slot-mobil]");if(y){const b=y.dataset.slotDriver,h=y.value,T=y.options[y.selectedIndex],A=h&&T?.text.split(" (")[0]||"",x=`${b}__${k.direction}`;k.slotDriverMap[x]=h;try{await I("/bookings/slot-assign",{method:"PATCH",body:{trip_date:k.date,trip_time:b,direction:k.direction,driver_id:h||null,driver_name:A}}),O("Driver berhasil diperbarui")}catch(R){v(R.message||"Gagal memperbarui driver")}}if(p){const b=p.dataset.slotMobil,h=p.value,T=`${b}__${k.direction}`;k.slotMobilMap[T]=h}}),t?.addEventListener("click",()=>{wt(),D("booking-form-modal")}),i?.addEventListener("click",f=>{const y=f.target.closest("[data-seat-code]");if(!y||y.disabled)return;Tt();const p=y.dataset.seatCode;k.selectedSeats.includes(p)?k.selectedSeats=k.selectedSeats.filter(b=>b!==p):k.selectedSeats.length<mt()&&(k.selectedSeats=Jt([...k.selectedSeats,p])),be(),fe()}),document.getElementById("booking-passenger-count")?.addEventListener("change",()=>{Tt(),be(),fe(),$e()}),document.getElementById("booking-trip-date")?.addEventListener("change",()=>{ot().then(()=>{be(),fe()})}),document.getElementById("booking-trip-time")?.addEventListener("change",()=>{ot().then(()=>{be(),fe()})}),document.getElementById("booking-from-city")?.addEventListener("change",$e),document.getElementById("booking-to-city")?.addEventListener("change",$e),d?.addEventListener("change",Wt),m?.addEventListener("input",f=>{const y=f.target.closest("[data-passenger-seat]");if(!y)return;const p=y.dataset.passengerSeat;k.passengerDraftMap[p]={seat_no:p,name:y.querySelector("[data-passenger-name]")?.value.trim()||"",phone:y.querySelector("[data-passenger-phone]")?.value.trim()||""}}),o?.addEventListener("submit",async f=>{f.preventDefault();const y=document.getElementById("booking-submit-btn");se(y,!0,"Menyimpan...");try{const p=Ks();k.editItem?(await I(`/bookings/${k.editItem.id}`,{method:"PUT",body:p}),O("Data pemesanan berhasil diperbarui")):(await I("/bookings",{method:"POST",body:p}),O("Data pemesanan berhasil ditambahkan")),G("booking-form-modal"),wt(),await Se()}catch(p){v(p.message||"Silakan periksa kembali data yang diinput","Gagal menyimpan data pemesanan")}finally{se(y,!1,"Menyimpan...")}}),s?.addEventListener("click",async()=>{if(k.deleteItem){se(s,!0,"Menghapus...");try{await I(`/bookings/${k.deleteItem.id}`,{method:"DELETE"}),O("Data pemesanan berhasil dihapus"),G("booking-delete-modal"),k.deleteItem=null,await Se()}catch(f){v(f.message||"Gagal menghapus data pemesanan")}finally{se(s,!1,"Menghapus...")}}}),wt(),Se().catch(f=>{if(f.status===403){Un();return}v(f.message||"Gagal memuat data penumpang")})}function Qs(e){const t=document.getElementById(e);if(!t)return{};try{return JSON.parse(t.textContent||"{}")}catch{return{}}}function Ys(){const e=document.querySelector("[data-regular-booking-page]");if(!e)return;const t=Qs("regular-booking-route-matrix"),n=e.querySelector("[data-booking-origin]"),a=e.querySelector("[data-booking-destination]"),r=e.querySelector("[data-booking-schedule]"),o=e.querySelector("[data-booking-passengers]"),s=e.querySelector("[data-route-fare-input]"),i=e.querySelector("[data-additional-fare-input]"),m=e.querySelector("[data-estimated-total-input]"),d=e.querySelector("[data-route-feedback]"),l=e.querySelector("[data-route-feedback-title]"),u=e.querySelector("[data-route-feedback-text]"),f=e.querySelector("[data-booking-submit]"),y=Array.from(e.querySelectorAll("[data-booking-type]")),p=e.querySelector("[data-summary-booking-for]"),b=e.querySelector("[data-summary-route]"),h=e.querySelector("[data-summary-schedule]"),T=e.querySelector("[data-summary-passengers]"),A=e.querySelector("[data-summary-fare]"),x=e.querySelector("[data-summary-additional-fare]"),R=e.querySelector("[data-summary-total]"),P=new Map(y.map(_=>[_.value,_.dataset.label||_.value])),q=new Map(Array.from(r?.options||[]).filter(_=>_.value).map(_=>[_.value,_.textContent.trim()]));function U(_,j){if(!_||!j||_===j)return null;const V=t?.[_]?.[j];return V==null?null:Number(V)}function Z(_,j,V){!d||!l||!u||(d.dataset.state=_,l.textContent=j,u.textContent=V)}function K(){e.querySelectorAll(".regular-booking-radio").forEach(_=>{const j=_.querySelector('input[type="radio"]');_.classList.toggle("is-selected",!!j?.checked)})}function Ne(_){return _<=0?"Belum dipilih":_===6?"6 Penumpang (Opsional tambahan)":`${_} Penumpang`}function te(){const _=n?.value||"",j=a?.value||"",V=r?.value||"",le=Number(o?.value||0),F=y.find(pt=>pt.checked)?.value||"",Q=U(_,j),z=Math.max(parseInt(i?.value||"0",10)||0,0),ae=Q!==null&&le>0?(Q+z)*le:null;s&&(s.value=Q!==null?M(Q):""),m&&(m.value=ae!==null?M(ae):""),!_||!j?Z("idle","Tarif akan ditampilkan otomatis","Pilih asal dan tujuan untuk melihat tarif perjalanan reguler."):_===j?Z("error","Asal dan tujuan tidak boleh sama","Silakan pilih tujuan yang berbeda agar tarif dapat dihitung."):Q===null?Z("error","Rute belum tersedia","Rute yang Anda pilih saat ini belum tersedia. Silakan pilih kombinasi asal dan tujuan lain."):Z("ready","Rute tersedia","Tarif telah diisi otomatis berdasarkan kombinasi rute dua arah yang tersedia."),f&&(f.disabled=!!(_&&j&&(_===j||Q===null))),p&&(p.textContent=P.get(F)||"Belum dipilih"),b&&(b.textContent=_&&j?`${_} - ${j}`:"Belum dipilih"),h&&(h.textContent=q.get(V)||"Belum dipilih"),T&&(T.textContent=Ne(le)),A&&(A.textContent=Q!==null?M(Q):"Belum tersedia"),x&&(x.textContent=z>0?M(z):"Tidak ada"),R&&(R.textContent=ae!==null?M(ae):"Belum tersedia"),K()}[n,a,r,o].forEach(_=>{_?.addEventListener("change",te)}),i?.addEventListener("input",te),y.forEach(_=>{_.addEventListener("change",te)}),e.querySelector("form")?.addEventListener("reset",()=>{window.requestAnimationFrame(te)}),te()}function ei(){const e=document.querySelector("[data-regular-booking-seat-page]");if(!e)return;const t=Number(e.dataset.requiredSeatCount||0),n=Array.from(e.querySelectorAll("[data-seat-card]")),a=Array.from(e.querySelectorAll("[data-seat-input]")),r=e.querySelector("[data-seat-summary-count]"),o=e.querySelector("[data-seat-summary-list]"),s=e.querySelector("[data-seat-summary-remaining]"),i=e.querySelector("[data-seat-submit]"),m=e.querySelector("[data-seat-feedback]"),d=e.querySelector("[data-seat-feedback-title]"),l=e.querySelector("[data-seat-feedback-text]");function u(){return a.filter(b=>b.checked).map(b=>b.value)}function f(b){return b.length>0?b.join(", "):"Belum dipilih"}function y(b,h,T){!m||!d||!l||(m.dataset.state=b,d.textContent=h,l.textContent=T)}function p(){const b=u(),h=b.length,T=t>0&&h>=t;if(n.forEach(A=>{const x=A.querySelector("[data-seat-input]");if(!x)return;const R=x.disabled&&!x.checked&&A.classList.contains("is-occupied"),P=x.checked,q=R||T&&!P;R||(x.disabled=q),A.classList.toggle("is-selected",P),A.classList.toggle("is-disabled",!R&&q)}),r&&(r.textContent=`${h} dari ${t}`),o&&(o.textContent=f(b)),s&&(s.textContent=String(Math.max(t-h,0))),i&&(i.disabled=h!==t),h===0){y("idle","Pilih kursi sesuai jumlah penumpang","Jumlah kursi yang dipilih harus sama dengan jumlah penumpang pada booking draft.");return}if(h<t){y("idle","Pemilihan kursi belum lengkap",`Masih perlu memilih ${t-h} kursi lagi sebelum dapat melanjutkan.`);return}if(t===6){y("ready","Semua kursi sudah terisi","Jumlah penumpang 6 orang sudah terpenuhi dan kursi tambahan 2B ikut terpakai.");return}y("ready","Kursi sudah sesuai","Jumlah kursi yang dipilih sudah sesuai dengan jumlah penumpang dan siap disimpan.")}a.forEach(b=>{b.addEventListener("change",()=>{p()})}),p()}const ti={"admin-users/index":Is,"auth/login":ho,"bookings/index":Zs,"dashboard/index":xo,"drivers/index":No,"mobil/index":Xo,"keberangkatan/index":as,"regular-bookings/index":Ys,"regular-bookings/seats":ei,"stock/index":ls};document.addEventListener("DOMContentLoaded",async()=>{po(),bo(),Ke(pa());const e=so();e&&(e.type==="success"?O(e.message,e.title):e.type==="info"?go(e.message,e.title):v(e.message,e.title));try{const{user:t}=await mo();t&&Ke(t);const n=document.body.dataset.pageScript,a=ti[n];typeof a=="function"&&await a({user:t})}catch(t){console.error(t),v(t.message||"Terjadi kesalahan saat memuat halaman")}});
